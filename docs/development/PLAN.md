...
**Status: COMPLETE except 7.13 (D-47), 0.29.0** · Depends: nothing
...
4. **The v2 project rules.** Four things, and the first is a prerequisite for
   ...
   d. **DONE in 0.26.0. Lifecycle authority and fork (7.11, 7.12).** Deactivation is `closed`
...
7. **DONE in 0.29.0. Secure verified export (section 8)**, which is what makes every governance
