...
**Incomplete sections** ·
- §The catalogue — 25 of the 35 kinds `queuestate.mjs` now carries have NO PRODUCER, and this list does not say which. The live ten are named in the Status above; the file that knows is `bio-plane/src/queuestate.mjs`, whose header states the split.
