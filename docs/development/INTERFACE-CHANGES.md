...
- **Interface:** I3 (plane → UI, the op contracts). **Base read off THIS TREE: 38.0.0** (`7042404e`, IC-157 resolved).
  **Proposed MAJOR — 38.0.0 → 39.0.0**, by IC-137's precedent: two refusals where a publish stood. Read the base AT
  RESOLUTION.
