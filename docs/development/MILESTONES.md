...
COORD-POINTER: this section lives on the branch `coord` as `docs/development/PLACEMENT.md` — read it with `node tools/coord.mjs read docs/development/PLACEMENT.md` (docs/development/TREE-SHARING.md §1, BOB #28's ruling 3; M0-110).
