...
| 7 | M0-73 | new | running | with D-430, a precondition of LED-6's split: without it a blocked backlog row leaves `owed` and a backlog-only id sets no floor |
...
| 13 | REC-146 | new | queued | BOB #14's item 5 (8.contradiction), after the claim and attribution rows it follows; the pairing read first |
| 14 | M0-71 | new | queued | the measurement IDENTIFY's judgement must pass, BEFORE anything a member sees; after REC-146 |
| 15 | REC-147 | new | blocked | blocked on M0-71's measured gate |
| 16 | UI-68 | new | queued | BOB #14's item 8 (13.review-copy), its in-instance surfaces; the plane half is built |
| 17 | REC-148 | new | queued | DEC-31's in-band quartet, before any review copy leaves the instance |
| 18 | UI-69 | new | queued | after UI-68 and REC-148: export only once the quartet travels with it |
| 19 | REC-149 | new | queued | Bob's 2026-09-18 ruling (DISCOVERABLE/HIDDEN), after BOB #14's listed items; the plane half first |
| 20 | REC-150 | new | queued | after REC-149, whose EXISTENCE level it needs |
| 21 | UI-70 | new | queued | after REC-149, and after UI-66 on the same forms |
| 22 | UI-71 | new | queued | after REC-149 and REC-150 |
| 23 | REC-122 | 11 | queued | runnable product work (M4, D-161's last act); REC-120 is done; not on BOB #14's list, which governs only rows added after it |
| 24 | CAP-11 | 18 | queued | runnable since CAP-10 landed (M2 measurement); placement CONFIRMED as SCHEDULER's by BOB #15 (BOB #14's list governed rows added after it) |
| 25 | FW-20 | 19 | queued | runnable since CPDF-19 landed (M2 breadth); placement CONFIRMED as SCHEDULER's by BOB #15 (BOB #14's list governed rows added after it) |
| 26 | CPDF-3 | 16 | queued | unblocked at this audit (its deploy blocker is false); an M2 live verification, after the product rows above |
| 27 | DIST-5 | 22 | queued | DIST's own reconciliation, ACCEPTED by DIST 2026-09-18 and queued in its session behind the REC-143 P0; holds no general slot |
| 28 | M0-65 | 13 | running | M0, first among M0 rows by BOB #15's lift of the hold (2026-09-18): the battery's published assertion total misstates what it counts — the record overclaiming about its own verification |
| 29 | M0-68 | new | queued | M0, right after the battery tally: an instrument asserting a closed defect fails against every current plane — a correction to a superseded test |
| 30 | M0-72 | new | queued | M0; a negative control reporting a false FAIL, with M0-68's class of test corrections |
| 31 | M0-69 | new | queued | M0, after the battery tally and M0-68: a live verification whose scratch keeps member rows stops measuring the same subject twice |
| 32 | M0-70 | new | queued | M0, after M0-68 and M0-69: the same instrument file as M0-68, and its purge-after rests on M0-69 |
| 33 | VF-7 | 17 | queued | M0 VERIFY lane, after the battery tally: it watches a credential class (DEC-43's zero), now a read-back since the 0.58.0 deploy armed it |
| 34 | M0-66 | 14 | queued | M0; an instrument producing false findings |
| 35 | M0-64 | 12 | queued | M0; a control arm proving less than it declares |
| 36 | M0-44 | 3 | queued | M0; seven truncated claims invisible to the bounds instrument |
| 37 | M0-33 | 4 | queued | M0; a third census shape |
| 38 | SK-5 | 21 | blocked | blocked: no plane op publishes the surface registry |
| 39 | UI-60 | 20 | blocked | blocked: waits on Bob's re-prioritisation of UI |
| 40 | REC-15 | 15 | blocked | blocked: DEC-33's deferral stands (the live publishing route is a human's own session); BOB #14's item 11 also places it after items 2, 5 and 6 |
| 41 | UI-17 | 23 | blocked | blocked: rests on REC-15 |
...
order: 7 · with D-430, a precondition of LED-6's split: without it a blocked backlog row leaves `owed` and a backlog-only id sets no floor (SCHEDULER, 2026-09-19)
...
order: 13 · BOB #14's item 5 (8.contradiction), after the claim and attribution rows it follows; the pairing read first (SCHEDULER, 2026-09-19)
milestone: M9
...
order: 14 · the measurement IDENTIFY's judgement must pass, BEFORE anything a member sees; after REC-146 (SCHEDULER, 2026-09-19)
...
order: 15 · blocked on M0-71's measured gate (SCHEDULER, 2026-09-19)
milestone: M9
...
order: 16 · BOB #14's item 8 (13.review-copy), its in-instance surfaces; the plane half is built (SCHEDULER, 2026-09-19)
milestone: M10
...
order: 17 · DEC-31's in-band quartet, before any review copy leaves the instance (SCHEDULER, 2026-09-19)
milestone: M10
...
order: 18 · after UI-68 and REC-148: export only once the quartet travels with it (SCHEDULER, 2026-09-19)
milestone: M10
...
order: 19 · Bob's 2026-09-18 ruling (DISCOVERABLE/HIDDEN), after BOB #14's listed items; the plane half first (SCHEDULER, 2026-09-19)
milestone: M8
...
order: 20 · after REC-149, whose EXISTENCE level it needs (SCHEDULER, 2026-09-19)
milestone: M8
interface: I3 (an IC minted with `node tools/mintid.mjs IC`)
...
order: 21 · after REC-149, and after UI-66 on the same forms (SCHEDULER, 2026-09-19)
milestone: M8
...
order: 22 · after REC-149 and REC-150 (SCHEDULER, 2026-09-19)
milestone: M8
...
order: 23 · runnable product work (M4, D-161's last act); REC-120 is done; not on BOB #14's list, which governs only rows added after it (SCHEDULER, first order audit, 2026-09-18)
...
order: 24 · runnable since CAP-10 landed (M2 measurement); placement CONFIRMED as SCHEDULER's by BOB #15 (BOB #14's list governed rows added after it) (SCHEDULER, first order audit, 2026-09-18)
...
order: 25 · runnable since CPDF-19 landed (M2 breadth); placement CONFIRMED as SCHEDULER's by BOB #15 (BOB #14's list governed rows added after it) (SCHEDULER, first order audit, 2026-09-18)
...
order: 26 · unblocked at this audit (its deploy blocker is false); an M2 live verification, after the product rows above (SCHEDULER, first order audit, 2026-09-18)
milestone: M2
...
order: 27 · DIST's own reconciliation, ACCEPTED by DIST 2026-09-18 and queued in its session behind the REC-143 P0; holds no general slot (SCHEDULER, 2026-09-18)
milestone: M7
...
order: 28 · M0, first among M0 rows by BOB #15's lift of the hold (2026-09-18): the battery's published assertion total misstates what it counts — the record overclaiming about its own verification (SCHEDULER, 2026-09-18, re-ordered at the lift of the M0 hold)
...
order: 29 · M0, right after the battery tally: an instrument asserting a closed defect fails against every current plane — a correction to a superseded test (SCHEDULER, 2026-09-18)
...
order: 30 · M0; a negative control reporting a false FAIL, with M0-68's class of test corrections (SCHEDULER, 2026-09-19)
milestone: M0 (background lane, holds no slot)
...
order: 31 · M0, after the battery tally and M0-68: a live verification whose scratch keeps member rows stops measuring the same subject twice (SCHEDULER, 2026-09-19)
...
order: 32 · M0, after M0-68 and M0-69: the same instrument file as M0-68, and its purge-after rests on M0-69 (SCHEDULER, 2026-09-19)
milestone: M0 (background lane, holds no slot)
...
order: 33 · M0 VERIFY lane, after the battery tally: it watches a credential class (DEC-43's zero), now a read-back since the 0.58.0 deploy armed it (SCHEDULER, 2026-09-18, re-ordered at the lift of the M0 hold)
...
order: 34 · M0; an instrument producing false findings (SCHEDULER, 2026-09-18, re-ordered at the lift of the M0 hold)
...
order: 35 · M0; a control arm proving less than it declares (SCHEDULER, 2026-09-18, re-ordered at the lift of the M0 hold)
...
order: 36 · M0; seven truncated claims invisible to the bounds instrument (SCHEDULER, 2026-09-18, re-ordered at the lift of the M0 hold)
milestone: M0 (background lane, holds no slot)
...
order: 37 · M0; a third census shape (SCHEDULER, 2026-09-18, re-ordered at the lift of the M0 hold)
...
order: 38 · blocked: no plane op publishes the surface registry (SCHEDULER, first order audit, 2026-09-18)
milestone: M9
...
order: 39 · blocked: waits on Bob's re-prioritisation of UI (SCHEDULER, first order audit, 2026-09-18)
milestone: M8
interface: none
...
### REC-15 · blocked
order: 40 · blocked: DEC-33's deferral stands (the live publishing route is a human's own session); BOB #14's item 11 also places it after items 2, 5 and 6 (SCHEDULER, first order audit, 2026-09-18)
milestone: M10
...
### UI-17 · blocked
order: 41 · blocked: rests on REC-15 (SCHEDULER, first order audit, 2026-09-18)
milestone: M10
