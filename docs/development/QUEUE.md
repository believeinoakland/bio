...
| 6 | REC-145 | new | running | a §7.9 disclosure: the refusal it removes tells a member a hidden project cites the question; with the disclosure rows |
| 7 | REC-153 | new | queued | an authority defect (a mislabelled context walks around the joined gate); right after REC-145, whose verdict it rests on |
| 8 | REC-152 | new | queued | authority: who may end a run; after REC-145, correcting its ARM H6 |
...
| 35 | M0-69 | new | queued | M0, after the battery tally and M0-68: a live verification whose scratch keeps member rows stops measuring the same subject twice |
| 36 | M0-70 | new | queued | M0, after M0-68 and M0-69: the same instrument file as M0-68, and its purge-after rests on M0-69 |
| 37 | VF-7 | 17 | queued | M0 VERIFY lane, after the battery tally: it watches a credential class (DEC-43's zero), now a read-back since the 0.58.0 deploy armed it |
| 38 | M0-66 | 14 | queued | M0; an instrument producing false findings |
| 39 | M0-64 | 12 | queued | M0; a control arm proving less than it declares |
| 40 | M0-44 | 3 | queued | M0; seven truncated claims invisible to the bounds instrument |
| 41 | M0-33 | 4 | queued | M0; a third census shape |
| 42 | SK-5 | 21 | blocked | blocked: no plane op publishes the surface registry |
| 43 | UI-60 | 20 | blocked | blocked: waits on Bob's re-prioritisation of UI |
| 44 | REC-15 | 15 | blocked | blocked: DEC-33's deferral stands (the live publishing route is a human's own session); BOB #14's item 11 also places it after items 2, 5 and 6 |
| 45 | UI-17 | 23 | blocked | blocked: rests on REC-15 |
...
order: 6 · a §7.9 disclosure: the refusal it removes tells a member a hidden project cites the question; with the disclosure rows (SCHEDULER, 2026-09-19)
milestone: M8
...
order: 7 · an authority defect (a mislabelled context walks around the joined gate); right after REC-145, whose verdict it rests on (SCHEDULER, 2026-09-19)
milestone: M8
...
order: 8 · authority: who may end a run; after REC-145, correcting its ARM H6 (SCHEDULER, 2026-09-19)
milestone: M8
interface: I3 — a refusal added (IC minted with `node tools/mintid.mjs IC`; the integrator classifies)
...
order: 35 · M0, after the battery tally and M0-68: a live verification whose scratch keeps member rows stops measuring the same subject twice (SCHEDULER, 2026-09-19)
...
order: 36 · M0, after M0-68 and M0-69: the same instrument file as M0-68, and its purge-after rests on M0-69 (SCHEDULER, 2026-09-19)
milestone: M0 (background lane, holds no slot)
...
order: 37 · M0 VERIFY lane, after the battery tally: it watches a credential class (DEC-43's zero), now a read-back since the 0.58.0 deploy armed it (SCHEDULER, 2026-09-18, re-ordered at the lift of the M0 hold)
...
order: 38 · M0; an instrument producing false findings (SCHEDULER, 2026-09-18, re-ordered at the lift of the M0 hold)
...
order: 39 · M0; a control arm proving less than it declares (SCHEDULER, 2026-09-18, re-ordered at the lift of the M0 hold)
...
order: 40 · M0; seven truncated claims invisible to the bounds instrument (SCHEDULER, 2026-09-18, re-ordered at the lift of the M0 hold)
milestone: M0 (background lane, holds no slot)
...
order: 41 · M0; a third census shape (SCHEDULER, 2026-09-18, re-ordered at the lift of the M0 hold)
...
order: 42 · blocked: no plane op publishes the surface registry (SCHEDULER, first order audit, 2026-09-18)
milestone: M9
...
order: 43 · blocked: waits on Bob's re-prioritisation of UI (SCHEDULER, first order audit, 2026-09-18)
milestone: M8
interface: none
...
### REC-15 · blocked
order: 44 · blocked: DEC-33's deferral stands (the live publishing route is a human's own session); BOB #14's item 11 also places it after items 2, 5 and 6 (SCHEDULER, first order audit, 2026-09-18)
milestone: M10
...
### UI-17 · blocked
order: 45 · blocked: rests on REC-15 (SCHEDULER, first order audit, 2026-09-18)
milestone: M10
