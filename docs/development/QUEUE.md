...
### CASE-6 · running — spawned 2026-09-10 by CONDUCT #9, Opus 5, worktree-isolated, into the slot CASE-5b freed. Falsify rather than believe: a live worker holds an `agent-*` worktree with commits toward the closing surfaces; if none does, this row reads `queued`.
milestone: M10
