...
### D-315 · queued — **the spawn died on the account monthly spend limit before any commit; see CPDF-10's note — respawn when a worker model clears.**
