...
| 2 | REC-152 | new | queued | authority: who may end a run (REC-145 on main); moved above the UI corrections at BOB #16's direction while weekly usage is short — disclosure and authority first |
| 3 | REC-151 | new | queued | a §7.9 disclosure (a sequential id counts hidden objects); REC-141 is ON MAIN (11aa7b13), so runnable; above the UI corrections at BOB #16's direction |
