...
depends-on: REC-124 (landed `d92522a8`) — CHECK AT THE CODE at spawn. **HELD FOR BOB #15's answer** on whether item 4 depends on the no-project adoption gap (asked 2026-09-18). Do not spawn until BOB answers, or rules that it does not.
