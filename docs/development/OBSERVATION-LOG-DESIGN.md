...
- §7 — the sweep-volume measurement (rows per day at the monitor's cadence over the census corpus) is named and not taken; the edge-triggered rule in §7 is the design's answer to the growth it expects, and the number that confirms it is owed.
