...
- [RULED: the renderer is immaterial. Authority follows the DATA.](#ruled-the-renderer-is-immaterial-authority-follows-the-data)
- [RULED: authority is three-valued, and undetermined is a task](#ruled-authority-is-three-valued-and-undetermined-is-a-task)
  - [RULED: an authority-undetermined capture cannot be PUBLISHED](#ruled-an-authority-undetermined-capture-cannot-be-published)
- [RULED: transitive trust is accepted, with disclosure and adjustment](#ruled-transitive-trust-is-accepted-with-disclosure-and-adjustment)
- [RULED: undetermined authority goes to a todo list, like an inbox](#ruled-undetermined-authority-goes-to-a-todo-list-like-an-inbox)
- [RULED: an alternative source counts as a re-fetch, for MONITORING](#ruled-an-alternative-source-counts-as-a-re-fetch-for-monitoring)
- [What D-55 becomes](#what-d-55-becomes)
- [RULED 2026-07-31: what publication actually requires](#ruled-2026-07-31-what-publication-actually-requires)
