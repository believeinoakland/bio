...
**REGISTER_FLOOR MOVED __FLOORLINE__**, ONE key set, all three in the same turn and every figure taken
...
`dist/bio-plane.bundled.mjs`; `src/signpage.mjs` regenerated BYTE-IDENTICALLY both times.
