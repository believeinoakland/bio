...
| `CONTENT-HTML` | **dormant, scope pending** · content inside HTML (D-64) · not yet carvable (link graph is CAPTURE's, recognizers are FRAMEWORK's, D-64 not buildable until `CLIENT-RENDERED.md`'s open questions are settled) | `kickoffs/CONTENT-HTML.md` |
