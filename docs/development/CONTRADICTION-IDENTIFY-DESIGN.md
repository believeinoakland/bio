...
**Incomplete sections** ·
- §7 — the over-strictness THRESHOLD is 0, PROVISIONAL (BOB #31, 2026-09-23, M0-71) until the first measurement over the fixture (§7) sets it in `MEASUREMENTS.md`; nothing reaches a member before then.
