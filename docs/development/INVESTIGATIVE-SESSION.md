...
- §11 — item 5, `replay` IS THE SERVER'S WORD (BOB #33, 2026-09-24, D-505's finding): step (1), the admin-class fence on a caller's `replay`, and step (2), server verification of every replayed promotion, are NOT BUILT (sent to SCHEDULER to row).
