...
depends-on: DIST's next cut from a tree with a GREEN FULL record (0.72.0's clone had none and ran the battery). DIST's act, never a worker slot, so it waits here.
