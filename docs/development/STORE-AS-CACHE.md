...
- §ABSENCE AS DATA — CORRECTED 2026-09-23 (BOB #29): the four states plus `partial` ARE built — `observation_log.state` (`schema.mjs`), vocabulary `airun.mjs` `OBSERVATION_STATES` — and D-129 is ruled in `BIO_Content_Framework_v0_10.md` §14.3. NOT BUILT: graded retention, deferred there with its trigger (the first unattended consumer that re-looks a subject by its state).
...
- §What to do, in order — item 7 says D-164 "stays PARKED until Bob reopens it"; D-164 was REOPENED 2026-09-15 and CLOSED 2026-09-22 (BOB #26, `BIO_Content_Framework_v0_10.md` §18), so item 7 is history.
