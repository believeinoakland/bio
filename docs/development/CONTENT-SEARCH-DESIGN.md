...
- §4.3 — **THE PER-CAPTURE BOUND IS NOT THE BOUND THAT BINDS, and the section's own argument
  ...
  because that is a decision about what a member's promote may cost.
