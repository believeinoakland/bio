...
- WHAT BOB #17 DECIDED — each folded into its home document; `decided.mjs` finds them - **TASK stays gated** (Membership v2 §7).  
  `docs/development/kickoffs/BOB-NEXT.md:70`
