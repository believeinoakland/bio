...
**Incomplete sections** ·
- §7 — whether an id the COUNTER issued for a gated prefix before REC-151 may later be drawn by the opaque minter is not ruled here. D-432 (2026-09-21) built it as NEVER, on the `op=purge` comment's rule; reversing it is one arm of `Store#seedMintLedger`.
...
- **BUILT 2026-09-21 by D-432 (IC-170) — AN ID THAT HAS EXISTED IS NEVER DRAWN AGAIN, PURGE OR NOT.** The `op=purge`
  ...
  before REC-151 — used or not, since an allocation handed out is an identifier that has existed. Nothing counts or lists
