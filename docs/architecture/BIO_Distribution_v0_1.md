...
| which build the DO and each member SERVE, read back and a lag named — the runtime half of the version authority | BUILT (D-116, IC-181, 2026-09-23; §6 rung 8); reaches a group only with the next cut that carries it |
