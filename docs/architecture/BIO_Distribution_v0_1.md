...
| an instance-held `ai` credential; a woken run re-entered | RULED 2026-09-21 (D-260; the assistant's §6); the plane READS `INSTANCE_AI_TOKEN` and re-enters the runs it opened (2026-09-23, IC-237); NOT BUILT: the deploy carries no such secret yet (`15.instance-ai-secret`) |
