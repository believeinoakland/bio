...
**Incomplete sections** ·
- §5 — seven design documents under `docs/development/` are governed; the rest join the governed table as each owner retrofits them (rowed by CONDUCT 2026-09-14, one item per owner group).
