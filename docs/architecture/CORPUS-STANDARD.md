...
| `docs/development/PROCESS-MECHANICS.md` | process document | describes how the process principles are carried out (PROPOSED 2026-09-25), not what the system is |
