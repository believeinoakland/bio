...
- §3 rule 2 / §4 — `op=ratify` still publishes three things OUTSIDE a case (an information bundle, an inquiry in no case, a finding prepared into a case not yet ratified), which rule 2 does not permit; measured and pinned by REC-140, a ruling owed by BOB (D-431).
