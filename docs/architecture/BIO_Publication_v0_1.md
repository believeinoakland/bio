...
**Incomplete sections** ·
- §5 — the ceremony (UI-17) and the preflight (REC-15) are DEFERRED on DEC-33's trigger; the section says what they are and that UI-18 has landed, which is the trigger's first clause — whether the second is met is the live question §9 names.
...
| the ceremony (UI-17) and the preflight (REC-15) | DEFERRED (DEC-33) — UI-18 has landed; **the live question for Bob is whether the second clause is met** |
