...
- **A PAGE AN IMAGE FILLS WHILE ITS TEXT IS A FOLIO SAYS SO, AND IS ROUTED TO OCR (D-627, 2026-09-25, M-178; BOB #35's
  ...
  **NOT BUILT, and each named.** (1) A chart painted as an image under a text title has the same two figures as a photo
  ...
  D-665 built it (the next bullet); only the OCR route for that class stays off, because no measured signal separates
  it. (2) A page
