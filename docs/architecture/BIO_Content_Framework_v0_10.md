...
**Incomplete sections** ·
- §8.4 — THEMES are designed (Bob's ruling, D-162, 2026-09-21) and NOT built: no theme object, no declaring act, no refusal of a theme as a basis leg.
...
**Measured once, 2026-09-23 (D-74, `measurements/M-117.md`) — a first sample, not a census.**
...
permits) were not read. Seven values in one inquiry is a lead, not a shared space; M-117
...
connected THROUGH a member's declared lens, visibly theirs. NOT BUILT: no theme object, act or refusal exists yet.
