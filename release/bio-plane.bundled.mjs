  ...
  docs.forEach((d, i) => {
    ...
    if (!Array.isArray(chain2) || chain2.length === 0) {
      findings.push(f(
        "C-18.9",
        "error",
        `provenance documents[${i}] is at or past verified with no provenance_chain: a published hash claims these bytes came from somewhere by some route, and this document names none`,
        [
