...
/* "inquiries" joins (REC-10); "focuses" and "problems" stay forever, because
   an exported corpus keeps the folder names it was exported under. */
const TYPE_ROOTS = ["information", "inquiries", "focuses", "problems", "projects", "actions"];
