...
function textUnitsFor(i2text, evidentiary = null) {
  ...
  if (i2text) {
    ...
    /* REC-204 — THE ENVELOPE, AFTER THE BODY IN READING ORDER. Its `seq`
       ...
       of importance backwards. A workbook has no body arm and its envelope
       items are indexed anyway: they are addressable, its cells are not. */
    const bodyLen = [i2text.pages, i2text.paragraphs, i2text.slides]
