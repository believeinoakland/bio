...
/* 1.31.0 (D-563, 2026-09-25, branch land/worker/D-563): TWO ARRIVALS, NO DEPARTURES, NONE CHANGED — C-86.3
...
/* 1.32.0 (D-578, 2026-09-25, branch land/worker/D-578, stacked on land/worker/D-563): ONE ARRIVAL, NO DEPARTURES, NONE
...
/* 1.34.0 (D-615, 2026-09-25, branch land/worker/D-615, stacked on land/worker/D-546): ONE ARRIVAL, NO DEPARTURES, NONE
...
/* 1.35.0 (D-628, 2026-09-25, branch land/worker/D-628, stacked on land/worker/D-615): ONE ARRIVAL, NO DEPARTURES, NONE
   ...
   on the merged tree. */
/* 1.36.0 (D-692, 2026-09-25, branch land/worker/D-692, stacked on land/worker/D-628): ONE ARRIVAL, NO DEPARTURES, NONE
   CHANGED — C-86.9 REVISION_REDATES_CREATION in PROMOTED_TYPE_CHECKS (a non-replay revision restating a different
...
/* 1.38.0 (D-726, 2026-09-25, branch land/worker/D-726, stacked on land/worker/D-707): ONE ARRIVAL, NO DEPARTURES, NONE
   CHANGED — C-86.14 REVISION_REGROUPS_BUNDLE in PROMOTED_TYPE_CHECKS (a non-replay revision whose document restates a
   different `group` is refused by name). MINOR; 513 -> 514, count and digest from the d470 suite's print on this tree. If
   another branch in the batch also moves the version, CONDUCT takes the next number at the union and re-reads the print
   on the merged tree. */
