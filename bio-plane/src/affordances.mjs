...
export const RUNG_ABSENT = {
  ...
  /* REC-122 / IC-228 — CHOOSING A CONNECTION'S ON-POINT MENTION, ground `undetermined` on
...
export const NON_ACTS = {
  ...
  /* REC-122 / IC-228. NOT an object-directed act, for `narrow`'s reason: its subject is ONE END
