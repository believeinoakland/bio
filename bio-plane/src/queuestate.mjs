 ...
 * is a VOCABULARY, not a producer: nothing in this plane emits a CONDITION item
 * today (store.mjs QUEUE_CLASSES_DEFERRED declares that absence, HOLE-1), and
 * this file does not change that. What it gives the mute is the set of kinds a
