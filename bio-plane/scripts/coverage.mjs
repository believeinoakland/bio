...
const FLEET_FLOOR = {
  ...
  arms: 86,   /* CONDUCT #20 (c20-integ1, 2026-09-24): 83 -> 86, RE-READ from the `FLEET` line a green `--strict` run PRINTED on this union (9/9 fleet suites declaring, 86 arms). Members, surface ops and suites are UNMOVED at 3/6/9: no fleet member, surface op or suite was added by this batch. */
};
