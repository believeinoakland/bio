...
const REGISTER_FLOOR = {
  ...
  /* MOVED 2026-09-15 by REC-95 (1087 -> 1093, 196 -> 197, 197 -> 198), ALL THREE IN THE
     ...
     M0-42 (2026-09-16) MOVED `arms` 1093 -> 1097, from the figure its own green run
     PRINTED (`arms 1097/1093 · classified 197/197 · corpus 198/198 · GREW by 4 arm(s)`)
     and never by adding 4 to the number above. `classified` and `corpus` DO NOT MOVE
     and that is correct rather than an oversight: this item added NO SUITE, only four
     arms to `register-grammar.test.mjs`'s existing declaration. **And the figure was
     read AFTER the declaration's last edit, which is this very suite's own documented
     mechanism turned on its own floor: writing a control's RESULTS back into its
     declaration raises the tally, so a figure read before that edit is already stale.**
     `run` is this item's new key and is set at the estate's ALREADY-HELD 164. */
  arms: 1097,
  classified: 197,
  corpus: 198,
