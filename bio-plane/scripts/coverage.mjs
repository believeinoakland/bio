...
const REGISTER_FLOOR = {
  ...
  // [MK-1 at its fourth merge, origin/main 442c01f4] ONE KEY SET, collapsed again: main carries 1284 (LED-2's ledger suite on top of REC-121/REC-123); MK-1's suite adds its 18 arms on top; the key is set from the merged tree's own post-commit print, not from this sum.
