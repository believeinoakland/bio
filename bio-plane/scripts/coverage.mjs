...
const REGISTER_FLOOR = {
  ...
  // [D-430] 2026-09-18: MOVED 1437 -> 1441, classified 244 -> 245, corpus 245 -> 246, run 207 -> 208, from this item's own `--strict` print on its COMMITTED MERGE with origin/main (REC-140 in) `0b5d1ff2` (`arms 1441/1437 · classified 245/244 · corpus (suites read) 246/245 · GREW by 4`, `floor 208/207 reproducible`); its pre-merge read at `1b096956` (1434/1430) is replaced, never added. One new suite, `pipeline-readers.test.mjs`, declaring four arms (NC1–NC4). Nothing FELL.
  classified: 245,
  corpus: 246,
