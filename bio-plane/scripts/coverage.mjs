...
const REGISTER_FLOOR = {
  ...
  // [M0-73] 2026-09-19: MOVED 1452 -> 1462 (classified 247, corpus 248, run 210 unchanged — no new suite), from this item's own `--strict` print on its COMMITTED MERGE with origin/main d978a4e1 (`arms 1462/1452 · classified 247/247 · corpus (suites read) 248/248 · GREW by 10 arm(s)`, `floor 210/210 reproducible`), exit 0. Cause: pipeline-readers.test.mjs's declaration gained the M0-73 arms (NC5, NC6a-c and their recorded results). ONE KEY SET.
  // [M0-73 at its merge with REC-145] 2026-09-19: collided (1462 M0-73's, 1464 main's); collapsed to ONE key and re-read on the COMMITTED merge 61f691bb from the `--strict` print: `arms 1474/1464 · classified 247/247 · corpus (suites read) 248/248 · GREW by 10 arm(s)`, `floor 210/210 reproducible`, exit 0.
  ...
  // [REC-152 at its merge with origin/main 2c99ca08] 2026-09-19: collided (1486 REC-152's, 1490 main's with M0-73); collapsed to ONE key set and re-read on the COMMITTED merge f8686fc3 from the `--strict` print: `arms 1496/1490 · classified 250/250 · corpus (suites read) 251/251 · GREW by 6 arm(s)`, `floor 213/213 reproducible`, exit 0.
  // [REC-153] 2026-09-19: [branch record, superseded at the merge below] read `--strict` print on its COMMITTED MERGE with origin/main `0a4f121d` (`arms 1465/1464 · classified 248/247 · corpus (suites read) 249/248 · GREW by 1`, `floor 211/210 reproducible`), exit 0. One new suite, `airun-contextkind.test.mjs`, declaring its control. Nothing FELL.
  // [REC-153, after BOB #16 7d03e852] 2026-09-19: MOVED 1480 -> 1482, classified 249 -> 250, corpus 250 -> 251, run 212 -> 213, from this item's own `--strict` print on its COMMITTED MERGE with origin/main `ef0d759b` (`arms 1482/1480 · classified 250/249 · corpus (suites read) 251/250 · GREW by 2`, `floor 213/212 reproducible`), exit 0. One new suite, `airun-contextkind.test.mjs`. Nothing FELL.
  // [CONDUCT #6 at M0-73's merge] 2026-09-19: collided (M0-73's 1474 on its branch, 1480 main's); collapsed to ONE key and re-read on the COMMITTED merge 538fbcb5 from the `--strict` print: `arms 1490/1480 · classified 249/249 · corpus (suites read) 250/250 · GREW by 10`, `floor 212/212 reproducible`.
  // [CONDUCT #6 at REC-153's merge] 2026-09-19: collided (REC-153's 1482, main's 1490); collapsed to ONE key and re-read on the COMMITTED merge 2b014a84 from the `--strict` print: `arms 1492/1490 · classified 250/250 · corpus (suites read) 251/251 · GREW by 2`, `floor 213/213 reproducible`.
  // [REC-151] 2026-09-19: MOVED 1480 -> 1487 (classified 249 -> 250, corpus 250 -> 251, run 212 -> 213), from this item's own `--strict` print on its COMMITTED tree 504bc879 (REC-151 merged with origin/main 20b7412f): `arms 1487/1480 · classified 250/249 · corpus (suites read) 251/250 · GREW by 7 arm(s)`, `floor 213/212 reproducible`, exit 0. Cause: the new opaque-ids.test.mjs, whose NEGATIVE CONTROL line declares seven arms. ONE KEY SET.
  // [REC-151 at its merge with M0-73] 2026-09-19: collided (1487 REC-151's, 1490 main's with M0-73); collapsed to ONE key and re-read on the COMMITTED merge 3a09894b from the `--strict` print: `arms 1497/1490 · classified 250/250 · corpus (suites read) 251/251 · GREW by 7 arm(s)`, `floor 213/213 reproducible`, exit 0 — the seven are opaque-ids'. ONE KEY SET.
  ...
  // [REC-135] 2026-09-19: MOVED 1505 -> 1511, classified 252 -> 253, corpus 253 -> 254, run 215 -> 216, ALL FOUR IN THE SAME TURN and all four from this item's own `--strict` print on its COMMITTED tree 5239ec7c (`arms 1511/1505 · classified 253/252 · corpus (suites read) 254/253 · GREW by 6 arm(s)`, `floor 216/215 reproducible · GREW by 1`), exit 0. Cause: ONE new suite, `case-project-conclusion.test.mjs`, driven by `case-project-conclusion.control.mjs` (six arms plus a baseline). NOTHING FELL. The figures were read AFTER the commit on purpose: before it the suite was untracked, the reproducible corpus still printed 253/253 with no slack, and a floor moved from that print would have been moved from a tree another checkout cannot reproduce (D-238). ONE KEY SET — CONDUCT re-reads on the merged tree.
  ...
  /* MOVED 2026-09-21 by D-432 (worktree `agent-ae1b7eca4d2254b16`, branch
     `worktree-agent-ae1b7eca4d2254b16`, base `fc94b045`): arms 1539 -> 1548, classified
     257 -> 258, corpus 258 -> 259 and run 220 -> 221, ALL FOUR IN THE SAME TURN and every
     one taken from the figure this item's own green `--strict` run PRINTED ON ITS COMMITTED
     TREE `d4150a60` (`REGISTER FLOOR  arms 1548/1539 · classified 258/257 · corpus (suites
     read) 259/258 · GREW by 9 arm(s)` and `221 RUN (dated token) … floor 221/220
     reproducible · GREW by 1`), exit 0 unpiped — never counted, never added to the numbers
     in the file. The cause is ONE new suite, `test/mint-ledger.test.mjs`, whose declaration
     states the arms `test/mint-ledger.control.mjs` runs (nine, all AS DECLARED) and carries a
     dated RESULTS token. Read AFTER the commit on purpose: before it the register printed the
  ...
  /* MOVED 2026-09-21 by D-436 (worktree `agent-a6dd0a0a3a3a6cc10`, branch `worktree-agent-a6dd0a0a3a3a6cc10`, base
     ...
     `2f09b7b6` (`REGISTER FLOOR  arms 1565/1552 · classified 259/258 · corpus (suites read) 260/259 · GREW by 13
     arm(s)` and `222 RUN (dated token) … floor 222/221 reproducible · GREW by 1`), exit 0 unpiped — never counted and
     never added by hand. The cause is ONE new suite, `test/instance-group.test.mjs`, whose declaration states the
  ...
  /* MOVED 2026-09-21 by the D-293/M0-98 worker (worktree `agent-aa5a3d09efb0f2f8c`, branch
     `worktree-agent-aa5a3d09efb0f2f8c`, rebased on `313f00ca`): arms 1566 -> 1576, classified 259 -> 260, corpus
     260 -> 261 and run 222 -> 223, ALL FOUR IN THE SAME TURN and every one taken from this item's own `--strict` run
     PRINTED ON ITS COMMITTED TREE `c35b73a7`, exit 0 unpiped: `REGISTER FLOOR  arms 1576/1566 · classified 260/259 ·
     corpus (suites read) 261/260 · GREW by 10 arm(s)` and `223 RUN (dated token) … floor 223/222 reproducible · GREW
     by 1` — never counted and never added by hand. The cause is ONE new suite, `test/gates.test.mjs`, whose
     declaration states the ten arms (1)–(10) `test/gates.control.mjs` runs, all AS DECLARED, with a dated RAN token.
     Nothing FELL. ONE KEY SET, grepped after writing: `^  arms:` matches TWICE in this file, here and in the FLEET
     block far below. */
  /* MOVED AGAIN 2026-09-21 by the same worker, 1576 -> 1577 ONLY, from the `--strict` print on its committed tree
  ...
  /* MOVED 2026-09-21 by M0-97 + D-341 (worktree `agent-aff9fd704ee856d24`, branch `worktree-agent-aff9fd704ee856d24`,
     ...
     `3c48ae9c` (`REGISTER FLOOR  arms 1581/1566 · classified 260/259 · corpus (suites read) 261/260 · GREW by 15
     arm(s)` and `223 RUN (dated token) … floor 223/222 reproducible · GREW by 1`), exit 0 unpiped — never counted and
     never added by hand. The cause is ONE new suite, `test/decided.test.mjs`, whose declaration states the fifteen
  ...
  /* [REC-163] 2026-09-22: MOVED 1622 -> 1632, classified 263 -> 264, corpus 264 -> 265, run 226 -> 227, ALL FOUR from
     this item's own `--strict` print on its COMMITTED tree `fd9b091f`, exit 0 unpiped (`REGISTER FLOOR  arms
     1632/1622 · classified 264/263 · corpus (suites read) 265/264 · GREW by 10 arm(s)`, `227 RUN (dated token) …
     floor 227/226 reproducible · GREW by 1`), provenance 281 of 281 in the commit at HEAD — never added by hand. One
     new suite, `test/group-public.test.mjs`, whose declaration states ten rows (a)-(j), each RUN by
     `test/group-public.control.mjs`. ONE KEY SET. Nothing FELL. */
  ...
  /* [CONDUCT #12] 2026-09-22, batch 4 (M0-99 onto REC-163's main): BOTH sides moved `arms` 1622 -> 1632 (ten arms each), so
  ...
  /* [REC-166] 2026-09-22: MOVED arms 1642 -> 1646, classified 264 -> 265, corpus 265 -> 266, run 227 -> 228, from this
     item's own `--strict` print, exit 0 unpiped (`REGISTER FLOOR  arms 1646/1642 · classified 265/264 · corpus (suites read)
  ...
  /* [CONDUCT #14 at REC-167's merge] 2026-09-22: RE-READ from `--strict` on the COMMITTED merge, exit 0 unpiped: `arms 1667/1663 · classified 268/267 · corpus (suites read) 269/268 · GREW by 4`, `floor 231/230 reproducible`. Never added by hand. */
  /* [CONDUCT #14 at M0-110's merge] 2026-09-22: RE-READ from `--strict` on the COMMITTED merge, exit 0 unpiped: `arms 1670/1667 · classified 269/268 · corpus (suites read) 270/269 · GREW by 3`, `floor 231/231`. M0-110 added coord.test.mjs and its control and moved no floor itself. Never added by hand. */
  ...
  /* [M0-114] 2026-09-22: MOVED from this item's own `--strict` print on its COMMITTED tree e6b9de01, exit 0 unpiped: `arms 1674/1670 · classified 270/269 · corpus (suites read) 271/270 · GREW by 4 arm(s)`, `floor 232/231 reproducible · GREW by 1`. One new suite, `test/pushguard-check.test.mjs`, four arms (1)-(4), RUN. Nothing FELL. ONE KEY SET. */
  /* [M0-114] 2026-09-23: MOVED again from `--strict` on the COMMITTED tree 52dd8e92, exit 0 unpiped: `arms 1675/1674 · classified 270/270 · corpus (suites read) 271/271 · GREW by 1 arm(s)` — arm (5), the workflow's errexit pin. ONE KEY SET. */
  /* [CONDUCT #14 at the REC-168 + M0-114 train merge] 2026-09-23: RE-READ from `--strict` on the COMMITTED merge, exit 0 unpiped: `arms 1691/1676 · classified 272/270 · corpus 273/271 · GREW by 15`, `floor 234/232 reproducible`. Both branches moved every key from one base. Never added by hand. */
  /* [CONDUCT #14 at M0-119's merge into the train] 2026-09-23: RE-READ from `--strict` on the COMMITTED merge: `arms 1694/1691 · GREW by 3`; the other keys exact. Never added by hand. */
  /* [CONDUCT #14 at D-442's merge] 2026-09-23: RE-READ from `--strict` on the COMMITTED merge, exit 0 unpiped: `arms 1700/1694 · classified 273/272 · corpus 274/273 · GREW by 6`, `floor 235/234 reproducible`. Never added by hand. */
  /* [CONDUCT #15 at M0-121's merge, batch with M0-122, gh-once-per-batch, fleet preserve-symlinks] 2026-09-23: RE-READ from `--strict` on the COMMITTED merge 496c1a97, exit 0 unpiped: `arms 1707/1700 · classified 274/273 · corpus (suites read) 275/274 · GREW by 7 arm(s)`, `floor 236/235 reproducible · GREW by 1` (statepaths.test.mjs and its control). Never added by hand. */
  /* [D-116] 2026-09-23: MOVED from this item's own `--strict` print on its merge with origin/main 619dfa65, exit 0 unpiped: `arms 1710/1707 · classified 275/274 · corpus (suites read) 276/275 · GREW by 3 arm(s)`, `floor 237/236 reproducible · GREW by 1` — the arrival is d116-serving-builds.test.mjs, arms (1)-(3). Never added by hand; CONDUCT re-reads on the merged tree. */
  /* [CONDUCT #15 at D-85's merge, batch with UI-79 and UI-80] 2026-09-23: RE-READ from `--strict` on the COMMITTED merge ace1ee2c, exit 0 unpiped: `arms 1722/1707 · classified 275/274 · corpus (suites read) 276/275 · GREW by 15 arm(s)`, `floor 237/236 reproducible · GREW by 1` (D-85's surfaces suite and its control; UI-79's and UI-80's suites are civicos-ui's, outside this register). Never added by hand. */
  /* [CONDUCT #15 at batch4's merge: M0-100 + CAP-13 + D-116 + three BOB docs] 2026-09-23: RE-READ from `--strict` on the COMMITTED merge 1e1490ec, exit 0 unpiped: `arms 1734/1722 · classified 278/275 · corpus (suites read) 279/276 · GREW by 12 arm(s)`, `floor 240/237 reproducible · GREW by 3` (cap13-reuse-pages, d116-serving-builds, M0-100's entries suite, with their controls). D-116's branch-side 1710 is replaced by this print, never added. Never added by hand. */
  /* [REC-171] 2026-09-23: MOVED from this item's own `--strict` print on its COMMITTED tree c927e002 (base 4355bfda), exit 0 unpiped: `arms 1743/1734 · classified 279/278 · corpus (suites read) 280/279 · GREW by 9 arm(s)`, `floor 241/240 reproducible · GREW by 1` — the arrival is rec171-surface-token.test.mjs and its nine-arm control. Nothing FELL. Never added by hand; CONDUCT re-reads on the merged tree. ONE KEY SET. */
  /* [REC-169 worker, branch record] 2026-09-23: MOVED arms 1734 -> 1743, classified 278 -> 279, corpus 279 -> 280, run 240 -> 241, from `--strict` (exit 0, unpiped) on its COMMITTED merge with origin/main 4355bfda, 6a26410a (`arms 1743/1734 · classified 279/278 · corpus (suites read) 280/279 · GREW by 9 arm(s)`, `floor 241/240 reproducible`): the one new suite rec169-consume.test.mjs and its nine arms. CONDUCT re-reads on the MERGED tree. Never added by hand. */
  /* [CONDUCT #15 at batch5's merge: REC-169 + REC-170 + DIST-6] 2026-09-23: RE-READ from `--strict` on the COMMITTED merge 6b5ac972, exit 0 unpiped: `arms 1749/1743 · classified 280/279 · corpus (suites read) 281/280 · GREW by 6 arm(s)`, `floor 242/241 reproducible · GREW by 1` (REC-170's rec170-manifest-pair suite and control; REC-169's own move to 1743 is replaced by this print, never added). */
  /* [CONDUCT #15 at batch6's merge: M0-127 + D-286 + DIST 0.75.0 pointer + BOB nevercache] 2026-09-23: RE-READ from `--strict` on the COMMITTED merge 1c793c98, exit 0 unpiped: `arms 1757/1749 · classified 281/280 · corpus (suites read) 282/281 · GREW by 8 arm(s)`, `floor 243/242 reproducible · GREW by 1` (M0-127's gateverdict suite and control). Never added by hand. */
  /* [CONDUCT #15 at batch7's merge: REC-171 + BOB migration-replay] 2026-09-23: RE-READ from `--strict` on the COMMITTED merge f68f0c38, exit 0 unpiped: `arms 1766/1757 · classified 282/281 · corpus (suites read) 283/282 · GREW by 9 arm(s)`, `floor 244/243 reproducible · GREW by 1` (REC-171's rec171-surface-token suite and control; its branch-side 1743 is replaced by this print, never added). */
  /* [REC-172 worker, worktree agent-ad79857cb007927b7] 2026-09-23: MOVED arms 1749 -> 1757, classified 280 -> 281, corpus 281 -> 282, run 242 -> 243, from `--strict` (exit 0 in the gate, unpiped) on its COMMITTED tree 418eec5a over origin/main 91913d6b (`arms 1757/1749 · classified 281/280 · corpus (suites read) 282/281 · GREW by 8 arm(s)`, `floor 243/242 reproducible · GREW by 1`) — the arrival is rec172-bounds.test.mjs, eight arms, one RUN-dated declaration. Never added by hand. */
  /* [REC-172 worker, branch record] 2026-09-23: RE-READ on its COMMITTED merge with origin/main d89e04d1 (bacbf9e6), `--strict` exit 0 unpiped: `arms 1765/1757 · classified 282/281 · corpus (suites read) 283/282 · GREW by 8 arm(s)`, `floor 244/243 reproducible · GREW by 1` — rec172-bounds.test.mjs's eight arms over batch6's figures, which the line above had also reached from a different arrival; ONE key set. Never added by hand. */
  ...
  /* M0-169 side, kept as history: arms 2100 on its own branch; the c20-batch25 union's figure is re-read from the print. */
  /* M0-173 side, kept as history: arms 2093 -> 2094 on its own branch; the c20-batch25 union's figure is re-read from --strict's print. */
  /* REC-213 side, kept as history: arms 2175 on its own branch; the c20-batch27 union's figure is re-read from --strict's print. */
  /* M0-188 side, kept as history: arms 2181 on its own branch; the c21-batch28 union's figure is re-read from --strict's print. */
  /* D-547 side, kept as history: arms 2191 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-524 side, kept as history: arms 2175 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-448 side, kept as history: arms 2177 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-512 side, kept as history: arms 2191 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* c21-rec207-renumber side, kept as history: arms 2133 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-530 side, kept as history: arms 2177 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-536 side, kept as history: arms 2178 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-454 side, kept as history: arms 2180 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* REC-155 side, kept as history: arms 2180 on its own branch (`arms 2180/2176 · classified 351/350 · corpus 352/351 · floor 314/313`, the rise rec155-session-routes.test.mjs four declared arms); the c22-batch29 union's figure is re-read from the print. */
  /* REC-150 side, kept as history: arms 2237 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* D-523 side, kept as history: arms 2181 on its own branch (2176 -> 2181, capturerequests.test.mjs's control arms (16)-(20)); the c22-batch29 union's figure is re-read from --strict's print. */
  /* D-134 side, kept as history: arms 2234 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* MK-7 side, kept as history: arms 2237 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* D-521b side, kept as history: arms 2359 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* D-561 side, kept as history: arms 2359 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* D-629 side, kept as history: arms 2363 on its own branch; the c22-batch30 union's figure is re-read from the print. */
  /* REC-215 side, kept as history: arms 2362 on its own branch; the c22-batch30 union's figure is re-read from the print. */
  /* D-419 side, kept as history: arms 2361 on its own branch; the c22-batch30 union's figure is re-read from the print. */
  /* D-564 side, kept as history (c22-batch30; ours' arms kept, NUMBER TO RE-READ from --strict's print on the union): arms: 2368 — D-564 2026-09-25: 2357 -> 2368, READ from the figure a --strict run PRINTED in the gate on this item's committed tree 02cb97cc (`arms 2368/2357 · classified 375/375 · corpus (suites read) 376/376 · GREW by 11 arm(s)`; run floor 337/337 unmoved). The cause is the seven suites' NEGATIVE CONTROL headers gaining D-564's recorder arms; no suite added, nothing FELL. THIS IS THIS BRANCH'S FIGURE; CONDUCT re-reads the union. */
  /* D-681 side, kept as history (c22-batch30; ours' arms kept, NUMBER TO RE-READ from --strict's print on the union): arms: 2364 — D-681 2026-09-25: 2357 -> 2364, READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on D-681's committed tree af9db9b3c9 (`REGISTER FLOOR  arms 2364/2357 · classified 376/375 · corpus (suites read) 377/376 · GREW by 7 arm(s)`, `floor 338/337 reproducible · GREW by 1`; provenance 394 of 394 in the commit at HEAD), exit 0 read UNPIPED. The cause is `leadlist.test.mjs` (five numbered control arms, all RUN) on top of land/worker/D-194, whose own growth had not been moved; CONDUCT re-reads these on the merged tree. */
  arms: 2689, /* CONDUCT #23 at c23-batch30: 2533 -> 2689, the c23-batch30 union READ from --strict's print on the committed tree (HEAD 832a0c13) (`REGISTER FLOOR  arms 2689/2533 · … GREW by 156 arm(s)`). */ /* CONDUCT #22 at c22-batch29: 2357 -> 2533, the c22-batch29 union READ from --strict's print (`REGISTER FLOOR  arms 2533/2357 · … GREW by 176 arm(s)`). */ /* CONDUCT #21 at c21-batch28: 2230 -> 2357, the c21-batch28 union (44 branches) READ from --strict's print. */ /* CONDUCT #20 at c20-batch27: 2176 -> 2230, the c20-batch27 union (19 worker branches) READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch26: 2171 -> 2176, the c20-batch26 union's control arms (per-suite attribution not measured), READ from --strict's print on the committed merge 41effd4bc. */ /* CONDUCT #20 at c20-batch25: 2163 -> 2171, D-476's control arms (its five plus D-469's two re-run) and REC-194/UI-93/D-518's over the batch, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch25: 2157 -> 2163, D-490's browser-render suite and nc-d490 arms, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch25: 2146 -> 2157, D-475's and D-510's suites and M0-179's arms over the batch, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch25: 2132 -> 2146, DIST-13's newgroup-bundle-fresh and M0-178's bundles suites over the batch, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch25: 2126 -> 2132, D-511's and D-491's control arms over the batch, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch25: 2122 -> 2126, M0-173 and M0-169 over the c20-batch24 union, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch23: 2098 -> 2122, the c20-batch22 + c20-batch23 union (D-497, D-499..D-502, D-507, D-508, D-509, M0-159/164/165, REC-211, REC-212 each moved it on its own branch), READ from --strict's print on the merged tree and re-read on the committed merge. */ /* REC-212 2026-09-24: 2097 -> 2098, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on this item's SECOND committed tree a49521b95 (`arms 2098/2097 · classified 342/342 · corpus (suites read) 343/343 · GREW by 1 arm(s)`; provenance: 360 of 360 discovered item(s) in the commit at HEAD), exit 0 read UNPIPED. `classified`, `corpus` and `run` do NOT move with it, and that is the discriminator: the ONE arm is a new CONTROL ARM RECORD on a suite this corpus already held — arm (d) of `rec212-statement-writer.test.mjs`, the re-run of arm (b) against the subject after `provenance-marker.test.mjs` §I's swallowed-read ceiling went RED and named this item's own `#statementWriter`. No suite was added in this commit. */ /* REC-212 2026-09-24: 2093 -> 2097, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on THIS ITEM'S OWN committed tree b9e9742de (`arms 2097/2093 · classified 342/341 · corpus (suites read) 343/342 · GREW by 4 arm(s)`, `floor 304/303 reproducible · GREW by 1`; provenance: 360 of 360 discovered item(s) in the commit at HEAD, so REPRODUCIBLE per D-238), exit 0 read UNPIPED — never counted, never incremented by hand. THE WHOLE RISE IS THIS ITEM'S OWN SUITE, and the SPLIT is what establishes it rather than a sentence claiming it: the same `--strict` run with `rec212-statement-writer.test.mjs` still UNTRACKED printed `arms 2093/2093 · classified 341/341 · corpus 342/342` and `floor 303/303 reproducible` — EXACTLY the floor on every key, so origin/main @ 68fecb8d carried NO slack here and none is being closed or absorbed. The four arms are the suite's three control arms plus its added key/prose agreement arm. */ /* CONDUCT #20 (c20-batch14, 2026-09-24): 2092 -> 2093, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the COMMITTED merge 1088835af (provenance: 359 of 359 items in the commit at HEAD). The ONE is origin/main @ 6761e903's (c20-batch19). `classified`, `corpus` and `run` do not move with it: UI-89's new suite is the UI harness's, not this corpus's. */ /* CONDUCT #20 (c20-batch14, 2026-09-24): 2080 -> 2092, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the COMMITTED merge fb6f618cd (provenance: 359 of 359 items in the commit at HEAD). The growth is origin/main @ 454a02bc's — c20-batch17 and c20-batch18's two new suites and their arms. Measured before and after the merge commit existed, because these keys are gated on HEAD (D-257). */ /* CONDUCT #20 (c20-batch14, 2026-09-24): 2078 -> 2080, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the COMMITTED merge 9498c141a (provenance: 357 of 357 items in the commit at HEAD). The TWO are origin/main @ 135abf3b's — c20-batch15's arms on suites this corpus already held, which is why `corpus` and `run` do not move with it. Measured before and after the merge commit existed, as D-257 requires. */ /* CONDUCT #20 (c20-batch14, 2026-09-24): 2073 -> 2078, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the COMMITTED merge 6587a249c (provenance: 357 of 357 items in the commit at HEAD). The growth is c20-batch13's `d470-catalog-census.test.mjs`: five arms, one classified suite, one suite read and one dated RUN token. MEASURED TWICE ON PURPOSE — before the merge was committed the same run printed one LESS for every HEAD-gated key (D-257), which is why the figure is taken here and never from the working tree. */ /* CONDUCT #20 (c20-batch14, 2026-09-24): 2069 -> 2073, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED after c20-batch13 was merged into this union. Whose growth it absorbs: the FOUR are c20-batch13's `d470-catalog-census.test.mjs` arms. */ /* CONDUCT #20 (c20-batch14, 2026-09-24): 2064 -> 2069, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the committed union of c20-batch11fix and c20-integ1b. ONE KEY SET, collapsed at this merge and re-read, never either branch's number: c20-integ1b's figures were true of ITS union (which lacked c19-batch11's suites) and c20-batch11fix's of ITS (which lacked D-64's). The growth this absorbs is the union's own. */   /* CONDUCT #20 (c20-integ1, 2026-09-24): 2043 -> 2064, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the committed union of origin/main @ 548eb2c5, D-64 and REC-184 — never counted, never incremented by hand. The growth is D-64's two new suites (rendered-capture.test.mjs and its control nc-d64.mjs) and REC-184's added arms in proposedispose.test.mjs. */ // c19-unionfix 2026-09-24: MOVED at integration from the union c19-batch9 + this branch's committed tree aeebf470's --strict print (`arms 2043/1894 · classified 333/301 · corpus 334/302`, `floor 295/265 reproducible`; provenance 351 of 351 in the commit at HEAD, so REPRODUCIBLE, D-238), exit 0. The rise is the batch's members (c18-batch7fix, c18-batch8, D-242, CAP-11, D-452, D-260, REC-159, REC-187, REC-198, D-162, folds-0924, D-176) and this branch's control records; origin/main 15b2a4c0 alone printed 1941/312/313 over its own floor 1832, so part of this is slack main already carried, closed here. // D-394 2026-09-23: MOVED from its committed tree 2dc74636's --strict print (`arms 1894/1832 · classified 301/289 · corpus 302/290`, `floor 265/253 reproducible`), exit 0. SPLIT: the same --strict run with this item's suite UNTRACKED printed a reproducible 1888/300/301 and run 264 — i.e. origin/main 02603e88 already stood 56/11/11/11 above this floor (pre-existing slack, closed here rather than carried); +6 arms, +1, +1, +1 are this item's own suite. // D-470 2026-09-24: MOVED from THIS ITEM'S OWN committed tree ae0962a7's `--strict` print (`arms 2048/2043 · classified 334/333 · corpus (suites read) 335/334 · GREW by 5 arm(s)`, `floor 296/295 reproducible · GREW by 1`), exit 0 read UNPIPED. The whole rise is this item's own suite: `d470-catalog-census.test.mjs` with five declared arms and a dated RUN token. The same run with the suite UNTRACKED and then STAGED printed 2043/333/334 and run 295 — the floor exactly — which is what establishes the delta is this suite and not slack main was carrying.
  /* (REC-211's own line, kept as history) arms: 2096, /* REC-211 (2026-09-24, branch land/worker/REC-211): 2093 -> 2096, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on this item's own COMMITTED tree 677dfc870 (provenance: 359 of 359 discovered items in the commit at HEAD), exit 0 read UNPIPED. The THREE are this item's own negative-control arms (A), (B) and (C) declared on `proposedispose.test.mjs`'s NEGATIVE CONTROL line. `classified`, `corpus` and `run` do NOT move with it and are unchanged at 341/342/303: this item added no suite and no dated RUN token — it added arms to a suite this corpus already held, which is exactly the shape that moves `arms` alone. *\/ /* CONDUCT #20 (c20-batch14, 2026-09-24): 2092 -> 2093, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the COMMITTED merge 1088835af (provenance: 359 of 359 items in the commit at HEAD). The ONE is origin/main @ 6761e903's (c20-batch19). `classified`, `corpus` and `run` do not move with it: UI-89's new suite is the UI harness's, not this corpus's. *\/ /* CONDUCT #20 (c20-batch14, 2026-09-24): 2080 -> 2092, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the COMMITTED merge fb6f618cd (provenance: 359 of 359 items in the commit at HEAD). The growth is origin/main @ 454a02bc's — c20-batch17 and c20-batch18's two new suites and their arms. Measured before and after the merge commit existed, because these keys are gated on HEAD (D-257). *\/ /* CONDUCT #20 (c20-batch14, 2026-09-24): 2078 -> 2080, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the COMMITTED merge 9498c141a (provenance: 357 of 357 items in the commit at HEAD). The TWO are origin/main @ 135abf3b's — c20-batch15's arms on suites this corpus already held, which is why `corpus` and `run` do not move with it. Measured before and after the merge commit existed, as D-257 requires. *\/ /* CONDUCT #20 (c20-batch14, 2026-09-24): 2073 -> 2078, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the COMMITTED merge 6587a249c (provenance: 357 of 357 items in the commit at HEAD). The growth is c20-batch13's `d470-catalog-census.test.mjs`: five arms, one classified suite, one suite read and one dated RUN token. MEASURED TWICE ON PURPOSE — before the merge was committed the same run printed one LESS for every HEAD-gated key (D-257), which is why the figure is taken here and never from the working tree. *\/ /* CONDUCT #20 (c20-batch14, 2026-09-24): 2069 -> 2073, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED after c20-batch13 was merged into this union. Whose growth it absorbs: the FOUR are c20-batch13's `d470-catalog-census.test.mjs` arms. *\/ /* CONDUCT #20 (c20-batch14, 2026-09-24): 2064 -> 2069, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the committed union of c20-batch11fix and c20-integ1b. ONE KEY SET, collapsed at this merge and re-read, never either branch's number: c20-integ1b's figures were true of ITS union (which lacked c19-batch11's suites) and c20-batch11fix's of ITS (which lacked D-64's). The growth this absorbs is the union's own. *\/   /* CONDUCT #20 (c20-integ1, 2026-09-24): 2043 -> 2064, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the committed union of origin/main @ 548eb2c5, D-64 and REC-184 — never counted, never incremented by hand. The growth is D-64's two new suites (rendered-capture.test.mjs and its control nc-d64.mjs) and REC-184's added arms in proposedispose.test.mjs. *\/ // c19-unionfix 2026-09-24: MOVED at integration from the union c19-batch9 + this branch's committed tree aeebf470's --strict print (`arms 2043/1894 · classified 333/301 · corpus 334/302`, `floor 295/265 reproducible`; provenance 351 of 351 in the commit at HEAD, so REPRODUCIBLE, D-238), exit 0. The rise is the batch's members (c18-batch7fix, c18-batch8, D-242, CAP-11, D-452, D-260, REC-159, REC-187, REC-198, D-162, folds-0924, D-176) and this branch's control records; origin/main 15b2a4c0 alone printed 1941/312/313 over its own floor 1832, so part of this is slack main already carried, closed here. // D-394 2026-09-23: MOVED from its committed tree 2dc74636's --strict print (`arms 1894/1832 · classified 301/289 · corpus 302/290`, `floor 265/253 reproducible`), exit 0. SPLIT: the same --strict run with this item's suite UNTRACKED printed a reproducible 1888/300/301 and run 264 — i.e. origin/main 02603e88 already stood 56/11/11/11 above this floor (pre-existing slack, closed here rather than carried); +6 arms, +1, +1, +1 are this item's own suite. // D-470 2026-09-24: MOVED from THIS ITEM'S OWN committed tree ae0962a7's `--strict` print (`arms 2048/2043 · classified 334/333 · corpus (suites read) 335/334 · GREW by 5 arm(s)`, `floor 296/295 reproducible · GREW by 1`), exit 0 read UNPIPED. The whole rise is this item's own suite: `d470-catalog-census.test.mjs` with five declared arms and a dated RUN token. The same run with the suite UNTRACKED and then STAGED printed 2043/333/334 and run 295 — the floor exactly — which is what establishes the delta is this suite and not slack main was carrying. */
  ...
  /* M0-169 side, kept as history: corpus 344 on its own branch; the c20-batch25 union's figure is re-read from the print. */
  /* REC-155 side, kept as history: classified 351 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* REC-150 side, kept as history: classified 357 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* D-134 side, kept as history: classified 357 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* MK-7 side, kept as history: classified 357 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* D-629 side, kept as history: classified 376 on its own branch; the c22-batch30 union's figure is re-read from the print. */
  /* REC-215 side, kept as history: classified 376 on its own branch; the c22-batch30 union's figure is re-read from the print. */
  /* D-419 side, kept as history: classified 376 on its own branch; the c22-batch30 union's figure is re-read from the print. */
  /* D-681 side, kept as history (c22-batch30; ours' classified kept, NUMBER TO RE-READ from --strict's print on the union): classified: 376 — D-681 2026-09-25: 375 -> 376, READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on D-681's committed tree af9db9b3c9 (`REGISTER FLOOR  arms 2364/2357 · classified 376/375 · corpus (suites read) 377/376 · GREW by 7 arm(s)`, `floor 338/337 reproducible · GREW by 1`; provenance 394 of 394 in the commit at HEAD), exit 0 read UNPIPED. The cause is `leadlist.test.mjs` (five numbered control arms, all RUN) on top of land/worker/D-194, whose own growth had not been moved; CONDUCT re-reads these on the merged tree. */
  classified: 425, /* CONDUCT #23 at c23-batch30: 399 -> 425, the c23-batch30 union READ from --strict's print on the committed tree (HEAD 832a0c13) (`classified 425/399`). */ /* CONDUCT #22 at c22-batch29: 375 -> 399, the c22-batch29 union READ from --strict's print (`classified 399/375`). */ /* CONDUCT #21 at c21-batch28: 356 -> 375, the c21-batch28 union (44 branches) READ from --strict's print. */ /* CONDUCT #20 at c20-batch27: 351 -> 356, the c20-batch27 union (19 worker branches) READ from --strict's print on the committed merge. */ /* REC-213 2026-09-24: 350 -> 351, MOVED IN THE SAME TURN as the other two and READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on this item's committed tree 725933dc1 (`REGISTER FLOOR  arms 2175/2171 · classified 351/350 · corpus (suites read) 352/351 · GREW by 4 arm(s)`), exit 0 read UNPIPED — never counted, never added by hand. The cause is ONE new suite, `test/rec213-reviewcopy-writer.test.mjs`, whose `NEGATIVE CONTROL:` declaration states FOUR arms (a baseline plus (a), (b), (c)), every one of them RUN. Nothing FELL. THIS IS THIS BRANCH'S FIGURE AND WILL NOT BE THE UNION'S — `land/worker/REC-213` is based on `origin/main` 1a7f0bcc merged with `origin/land/conduct/c20-batch25`, and CONDUCT re-reads these three from a green run on the merged tree. */ /* CONDUCT #20 at c20-batch25: 349 -> 350, D-490's browser-render suite and nc-d490 arms, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch25: 347 -> 349, D-475's and D-510's suites and M0-179's arms over the batch, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch25: 345 -> 347, DIST-13's newgroup-bundle-fresh and M0-178's bundles suites over the batch, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch25: 344 -> 345, M0-173 and M0-169 over the c20-batch24 union, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch23: 342 -> 344, the c20-batch22 + c20-batch23 union (D-497, D-499..D-502, D-507, D-508, D-509, M0-159/164/165, REC-211, REC-212 each moved it on its own branch), READ from --strict's print on the merged tree and re-read on the committed merge. */ /* REC-212 2026-09-24: 341 -> 342, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on THIS ITEM'S OWN committed tree b9e9742de (`arms 2097/2093 · classified 342/341 · corpus (suites read) 343/342 · GREW by 4 arm(s)`, `floor 304/303 reproducible · GREW by 1`; provenance: 360 of 360 discovered item(s) in the commit at HEAD, so REPRODUCIBLE per D-238), exit 0 read UNPIPED — never counted, never incremented by hand. THE WHOLE RISE IS THIS ITEM'S OWN SUITE, and the SPLIT is what establishes it rather than a sentence claiming it: the same `--strict` run with `rec212-statement-writer.test.mjs` still UNTRACKED printed `arms 2093/2093 · classified 341/341 · corpus 342/342` and `floor 303/303 reproducible` — EXACTLY the floor on every key, so origin/main @ 68fecb8d carried NO slack here and none is being closed or absorbed. The four arms are the suite's three control arms plus its added key/prose agreement arm. */ /* CONDUCT #20 (c20-batch14, 2026-09-24): 339 -> 341, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the COMMITTED merge fb6f618cd (provenance: 359 of 359 items in the commit at HEAD). The growth is origin/main @ 454a02bc's — c20-batch17 and c20-batch18's two new suites and their arms. Measured before and after the merge commit existed, because these keys are gated on HEAD (D-257). */ /* CONDUCT #20 (c20-batch14, 2026-09-24): 338 -> 339, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the COMMITTED merge 6587a249c (provenance: 357 of 357 items in the commit at HEAD). The growth is c20-batch13's `d470-catalog-census.test.mjs`: five arms, one classified suite, one suite read and one dated RUN token. MEASURED TWICE ON PURPOSE — before the merge was committed the same run printed one LESS for every HEAD-gated key (D-257), which is why the figure is taken here and never from the working tree. */ /* CONDUCT #20 (c20-batch14, 2026-09-24): 337 -> 338, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the committed union of c20-batch11fix and c20-integ1b. ONE KEY SET, collapsed at this merge and re-read, never either branch's number: c20-integ1b's figures were true of ITS union (which lacked c19-batch11's suites) and c20-batch11fix's of ITS (which lacked D-64's). The growth this absorbs is the union's own. */   /* CONDUCT #20 (c20-integ1, 2026-09-24): 333 -> 337, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the committed union of origin/main @ 548eb2c5, D-64 and REC-184 — never counted, never incremented by hand. The growth is D-64's two new suites (rendered-capture.test.mjs and its control nc-d64.mjs) and REC-184's added arms in proposedispose.test.mjs. */ // c19-unionfix 2026-09-24: see arms. // D-394 2026-09-23: see arms. // D-440 2026-09-23: its committed merge 64711f5a printed 289/288 // D-470 2026-09-24: see arms. // D-470 2026-09-24: see arms.
  /* D-547 side, kept as history: classified 352 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-547 side, kept as history: corpus 353 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-524 side, kept as history: classified 351 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-524 side, kept as history: corpus 352 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-448 side, kept as history: classified 351 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-448 side, kept as history: corpus 352 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-512 side, kept as history: classified 351 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-512 side, kept as history: corpus 352 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* c21-rec207-renumber side, kept as history: classified 345 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* c21-rec207-renumber side, kept as history: corpus 346 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-530 side, kept as history: classified 351 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-530 side, kept as history: corpus 352 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-536 side, kept as history: classified 351 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-536 side, kept as history: corpus 352 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-454 side, kept as history: classified 351 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-454 side, kept as history: corpus 352 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* REC-155 side, kept as history: corpus 352 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* REC-150 side, kept as history: corpus 358 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* D-134 side, kept as history: corpus 358 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* MK-7 side, kept as history: corpus 358 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* D-629 side, kept as history: corpus 377 on its own branch; the c22-batch30 union's figure is re-read from the print. */
  /* REC-215 side, kept as history: corpus 377 on its own branch; the c22-batch30 union's figure is re-read from the print. */
  /* D-419 side, kept as history: corpus 377 on its own branch; the c22-batch30 union's figure is re-read from the print. */
  /* D-681 side, kept as history (c22-batch30; ours' corpus kept, NUMBER TO RE-READ from --strict's print on the union): corpus: 377 — D-681 2026-09-25: 376 -> 377, READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on D-681's committed tree af9db9b3c9 (`REGISTER FLOOR  arms 2364/2357 · classified 376/375 · corpus (suites read) 377/376 · GREW by 7 arm(s)`, `floor 338/337 reproducible · GREW by 1`; provenance 394 of 394 in the commit at HEAD), exit 0 read UNPIPED. The cause is `leadlist.test.mjs` (five numbered control arms, all RUN) on top of land/worker/D-194, whose own growth had not been moved; CONDUCT re-reads these on the merged tree. */
  corpus: 426, /* CONDUCT #23 at c23-batch30: 400 -> 426, the c23-batch30 union READ from --strict's print on the committed tree (HEAD 832a0c13) (`corpus (suites read) 426/400`). */ /* CONDUCT #22 at c22-batch29: 376 -> 400, the c22-batch29 union READ from --strict's print (`corpus (suites read) 400/376`). */ /* CONDUCT #21 at c21-batch28: 357 -> 376, the c21-batch28 union (44 branches) READ from --strict's print. */ /* CONDUCT #20 at c20-batch27: 352 -> 357, the c20-batch27 union (19 worker branches) READ from --strict's print on the committed merge. */ /* REC-213 2026-09-24: 351 -> 352, MOVED IN THE SAME TURN as the other two and READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on this item's committed tree 725933dc1 (`REGISTER FLOOR  arms 2175/2171 · classified 351/350 · corpus (suites read) 352/351 · GREW by 4 arm(s)`), exit 0 read UNPIPED — never counted, never added by hand. The cause is ONE new suite, `test/rec213-reviewcopy-writer.test.mjs`, whose `NEGATIVE CONTROL:` declaration states FOUR arms (a baseline plus (a), (b), (c)), every one of them RUN. Nothing FELL. THIS IS THIS BRANCH'S FIGURE AND WILL NOT BE THE UNION'S — `land/worker/REC-213` is based on `origin/main` 1a7f0bcc merged with `origin/land/conduct/c20-batch25`, and CONDUCT re-reads these three from a green run on the merged tree. */ /* CONDUCT #20 at c20-batch25: 350 -> 351, D-490's browser-render suite and nc-d490 arms, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch25: 348 -> 350, D-475's and D-510's suites and M0-179's arms over the batch, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch25: 346 -> 348, DIST-13's newgroup-bundle-fresh and M0-178's bundles suites over the batch, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch25: 345 -> 346, M0-173 and M0-169 over the c20-batch24 union, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch23: 343 -> 345, the c20-batch22 + c20-batch23 union (D-497, D-499..D-502, D-507, D-508, D-509, M0-159/164/165, REC-211, REC-212 each moved it on its own branch), READ from --strict's print on the merged tree and re-read on the committed merge. */ /* REC-212 2026-09-24: 342 -> 343, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on THIS ITEM'S OWN committed tree b9e9742de (`arms 2097/2093 · classified 342/341 · corpus (suites read) 343/342 · GREW by 4 arm(s)`, `floor 304/303 reproducible · GREW by 1`; provenance: 360 of 360 discovered item(s) in the commit at HEAD, so REPRODUCIBLE per D-238), exit 0 read UNPIPED — never counted, never incremented by hand. THE WHOLE RISE IS THIS ITEM'S OWN SUITE, and the SPLIT is what establishes it rather than a sentence claiming it: the same `--strict` run with `rec212-statement-writer.test.mjs` still UNTRACKED printed `arms 2093/2093 · classified 341/341 · corpus 342/342` and `floor 303/303 reproducible` — EXACTLY the floor on every key, so origin/main @ 68fecb8d carried NO slack here and none is being closed or absorbed. The four arms are the suite's three control arms plus its added key/prose agreement arm. */ /* CONDUCT #20 (c20-batch14, 2026-09-24): 340 -> 342, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the COMMITTED merge fb6f618cd (provenance: 359 of 359 items in the commit at HEAD). The growth is origin/main @ 454a02bc's — c20-batch17 and c20-batch18's two new suites and their arms. Measured before and after the merge commit existed, because these keys are gated on HEAD (D-257). */ /* CONDUCT #20 (c20-batch14, 2026-09-24): 339 -> 340, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the COMMITTED merge 6587a249c (provenance: 357 of 357 items in the commit at HEAD). The growth is c20-batch13's `d470-catalog-census.test.mjs`: five arms, one classified suite, one suite read and one dated RUN token. MEASURED TWICE ON PURPOSE — before the merge was committed the same run printed one LESS for every HEAD-gated key (D-257), which is why the figure is taken here and never from the working tree. */ /* CONDUCT #20 (c20-batch14, 2026-09-24): 338 -> 339, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the committed union of c20-batch11fix and c20-integ1b. ONE KEY SET, collapsed at this merge and re-read, never either branch's number: c20-integ1b's figures were true of ITS union (which lacked c19-batch11's suites) and c20-batch11fix's of ITS (which lacked D-64's). The growth this absorbs is the union's own. */   /* CONDUCT #20 (c20-integ1, 2026-09-24): 334 -> 338, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the committed union of origin/main @ 548eb2c5, D-64 and REC-184 — never counted, never incremented by hand. The growth is D-64's two new suites (rendered-capture.test.mjs and its control nc-d64.mjs) and REC-184's added arms in proposedispose.test.mjs. */ // c19-unionfix 2026-09-24: see arms. // D-394 2026-09-23: see arms. // D-440 2026-09-23: its committed merge 64711f5a printed 290/289
  ...
  /* D-547 side, kept as history: run 315 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-524 side, kept as history: run 314 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-448 side, kept as history: run 314 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-512 side, kept as history: run 314 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* c21-rec207-renumber side, kept as history: run 308 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-530 side, kept as history: run 314 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-536 side, kept as history: run 314 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* D-454 side, kept as history: run 314 on its own branch; the c21-batch28 union's figure is re-read from the print. */
  /* REC-155 side, kept as history: run 314 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* REC-150 side, kept as history: run 320 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* D-134 side, kept as history: run 320 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* MK-7 side, kept as history: run 320 on its own branch; the c22-batch29 union's figure is re-read from the print. */
  /* D-629 side, kept as history: run 338 on its own branch; the c22-batch30 union's figure is re-read from the print. */
  /* REC-215 side, kept as history: run 338 on its own branch; the c22-batch30 union's figure is re-read from the print. */
  /* D-419 side, kept as history: run 338 on its own branch; the c22-batch30 union's figure is re-read from the print. */
  /* D-681 side, kept as history (c22-batch30; ours' run kept, NUMBER TO RE-READ from --strict's print on the union): run: 338 — D-681 2026-09-25: 337 -> 338, READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on D-681's committed tree af9db9b3c9 (`REGISTER FLOOR  arms 2364/2357 · classified 376/375 · corpus (suites read) 377/376 · GREW by 7 arm(s)`, `floor 338/337 reproducible · GREW by 1`; provenance 394 of 394 in the commit at HEAD), exit 0 read UNPIPED. The cause is `leadlist.test.mjs` (five numbered control arms, all RUN) on top of land/worker/D-194, whose own growth had not been moved; CONDUCT re-reads these on the merged tree. */
  run: 378, /* CONDUCT #23 at c23-batch30: 359 -> 378, the c23-batch30 union READ from --strict's print on the committed tree (HEAD 832a0c13) (`378 RUN (dated token) · … floor 378/359 reproducible · GREW by 19`). */ /* CONDUCT #22 at c22-batch29: 337 -> 359, the c22-batch29 union READ from --strict's print (`359 RUN (dated token) · … floor 359/337 reproducible · GREW by 22`). */ /* CONDUCT #21 at c21-batch28: 319 -> 337, the c21-batch28 union READ from --strict's print. */ /* CONDUCT #20 at c20-batch27: 314 -> 319, the c20-batch27 union (19 worker branches) READ from --strict's print on the committed merge. */ /* REC-213 2026-09-24: 313 -> 314, MOVED IN THE SAME TURN as `arms`/`classified`/`corpus` and READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on this item's committed tree 725933dc1 (`314 RUN (dated token) · 11 UNDETERMINED · 27 DECLARED-ONLY · of 352 declarations · floor 314/313 reproducible · GREW by 1`), exit 0 read UNPIPED — never counted, never incremented by hand. THE WHOLE RISE IS THIS ITEM'S OWN SUITE and the SPLIT establishes it rather than a sentence claiming it: the same `--strict` run with `rec213-reviewcopy-writer.test.mjs` still UNTRACKED printed `arms 2171/2171 · classified 350/350 · corpus 351/351` and `floor 313/313 reproducible` — EXACTLY the floor on every key, so this branch's base carried NO slack here and none is being closed or absorbed. THIS IS THIS BRANCH'S FIGURE AND WILL NOT BE THE UNION'S; CONDUCT re-reads it on the merged tree. */ /* CONDUCT #20 at c20-batch25: 312 -> 313, D-490's browser-render suite and nc-d490 arms, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch25: 310 -> 312, D-475's and D-510's suites and M0-179's arms over the batch, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch25: 308 -> 310, DIST-13's newgroup-bundle-fresh and M0-178's bundles suites over the batch, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch25: 307 -> 308, M0-173 and M0-169 over the c20-batch24 union, READ from --strict's print on the committed merge. */ /* CONDUCT #20 at c20-batch23: 304 -> 307, the c20-batch22 + c20-batch23 union (D-497, D-499..D-502, D-507, D-508, D-509, M0-159/164/165, REC-211, REC-212 each moved it on its own branch), READ from --strict's print on the merged tree and re-read on the committed merge. */ /* REC-212 2026-09-24: 303 -> 304, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on THIS ITEM'S OWN committed tree b9e9742de (`arms 2097/2093 · classified 342/341 · corpus (suites read) 343/342 · GREW by 4 arm(s)`, `floor 304/303 reproducible · GREW by 1`; provenance: 360 of 360 discovered item(s) in the commit at HEAD, so REPRODUCIBLE per D-238), exit 0 read UNPIPED — never counted, never incremented by hand. THE WHOLE RISE IS THIS ITEM'S OWN SUITE, and the SPLIT is what establishes it rather than a sentence claiming it: the same `--strict` run with `rec212-statement-writer.test.mjs` still UNTRACKED printed `arms 2093/2093 · classified 341/341 · corpus 342/342` and `floor 303/303 reproducible` — EXACTLY the floor on every key, so origin/main @ 68fecb8d carried NO slack here and none is being closed or absorbed. The four arms are the suite's three control arms plus its added key/prose agreement arm. */ /* CONDUCT #20 (c20-batch14, 2026-09-24): 301 -> 303, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the COMMITTED merge fb6f618cd (provenance: 359 of 359 items in the commit at HEAD). The growth is origin/main @ 454a02bc's — c20-batch17 and c20-batch18's two new suites and their arms. Measured before and after the merge commit existed, because these keys are gated on HEAD (D-257). */ /* CONDUCT #20 (c20-batch14, 2026-09-24): 300 -> 301, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the COMMITTED merge 6587a249c (provenance: 357 of 357 items in the commit at HEAD). The growth is c20-batch13's `d470-catalog-census.test.mjs`: five arms, one classified suite, one suite read and one dated RUN token. MEASURED TWICE ON PURPOSE — before the merge was committed the same run printed one LESS for every HEAD-gated key (D-257), which is why the figure is taken here and never from the working tree. */ /* CONDUCT #20 (c20-batch14, 2026-09-24): 299 -> 300, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the committed union of c20-batch11fix and c20-integ1b. ONE KEY SET, collapsed at this merge and re-read, never either branch's number: c20-integ1b's figures were true of ITS union (which lacked c19-batch11's suites) and c20-batch11fix's of ITS (which lacked D-64's). The growth this absorbs is the union's own. */   /* CONDUCT #20 (c20-integ1, 2026-09-24): 295 -> 299, RE-READ from the REPRODUCIBLE figure a green `--strict` run PRINTED on the committed union of origin/main @ 548eb2c5, D-64 and REC-184 — never counted, never incremented by hand. The growth is D-64's two new suites (rendered-capture.test.mjs and its control nc-d64.mjs) and REC-184's added arms in proposedispose.test.mjs. */ // c19-unionfix 2026-09-24: see arms. // D-394 2026-09-23: see arms. // D-440 2026-09-23: its committed merge 64711f5a printed floor 253/252 reproducible // D-470 2026-09-24: see arms.
};
...
const FLEET_FLOOR = {
  ...
  members: 3,
  surfaceOps: 7, /* D-419 2026-09-25: 6 -> 7, pdf-worker's `crop` (POST /crop), READ from --strict's `FLEET … 7/7 surface ops reached` on this item's committed tree; origin/main 5e8a65a8 printed 6/6. */
  ...
  /* 8 -> 9 AT INTEGRATION by c19-unionfix, 2026-09-24, from the union's --strict print (`9/9 SUITES declaring a
     negative control · 83 arms`): origin/main 15b2a4c0 ALREADY printed 9 suites and 79 arms over this 8 / 76, slack it
     carried and which is closed here rather than inherited. */
  suites: 9,
  ...
  /* 76 -> 83 AT INTEGRATION by c19-unionfix, 2026-09-24: main's own 79 (see `suites`) plus D-452's four new arms in
     agent-worker/test/harness.test.mjs (22 -> 26), diffed per suite against main's print. */
  /* D-419 side, kept as history: arms 90 on its own branch; the c22-batch30 union's figure is re-read from the print. */
  arms: 100, /* CONDUCT #22 at c22-batch29: 86 -> 100, the c22-batch29 union READ from --strict's print (`FLEET … 100 arms · floor … 86 arm(s) · GREW by 14 arm(s)`). */ /* CONDUCT #20 (c20-integ1, 2026-09-24): 83 -> 86, RE-READ from the `FLEET` line a green `--strict` run PRINTED on this union (9/9 fleet suites declaring, 86 arms). Members, surface ops and suites are UNMOVED at 3/6/9: no fleet member, surface op or suite was added by this batch. */
};
