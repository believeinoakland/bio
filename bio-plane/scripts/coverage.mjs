...
const REGISTER_FLOOR = {
  ...
  /* [REC-169 worker, branch record] 2026-09-23: MOVED arms 1722 -> 1731, classified 275 -> 276, corpus 276 -> 277, run 237 -> 238, from this item's own `--strict` print on its COMMITTED tree f9674d5d (`arms 1731/1722 · classified 276/275 · corpus (suites read) 277/276 · GREW by 9 arm(s)`, `floor 238/237 reproducible`): the one new suite rec169-consume.test.mjs and its nine arms. CONDUCT re-reads on the MERGED tree. */
  arms: 1731,
