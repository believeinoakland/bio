...
const REGISTER_FLOOR = {
  ...
  // [REC-152 at its merge with origin/main 2c99ca08] 2026-09-19: collided (1486 REC-152's, 1490 main's with M0-73); collapsed to ONE key set, to be re-read on the COMMITTED merge from the `--strict` print (next line).
  arms: 1490,
