...
const FLEET_FLOOR = {
  ...
  arms: 90,   /* D-419 2026-09-25: 86 -> 90, READ from --strict's `FLEET … 90 arms` — NOT this item's: origin/main 5e8a65a8 alone printed 90 arms over this floor (`GREW by 4 arm(s)`), slack main carried, closed here because a floor with slack is not one. */ /* CONDUCT #20 (c20-integ1, 2026-09-24): 83 -> 86, RE-READ from the `FLEET` line a green `--strict` run PRINTED on this union (9/9 fleet suites declaring, 86 arms). Members, surface ops and suites are UNMOVED at 3/6/9: no fleet member, surface op or suite was added by this batch. */
};
