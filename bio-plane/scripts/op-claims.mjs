...
export const LEDGER = [
  ...
  { file: "docs/development/CLAIMS.md", name: "publishcase", n: 3, kind: "DO-PATH",
    why: "REC-58's own released claim, quoting the sentence the item was raised on. Append-only history. DELEGATED to CONDUCT." },
  { file: "docs/development/CLAIMS.md", name: "inboxlist", n: 1, kind: "DO-PATH",
    why: "a released claim quoting a suite's op list. Append-only history. DELEGATED to CONDUCT." },
  { file: "docs/development/CLAIMS.md", name: "reusedparts", n: 1, kind: "DO-PATH", why: "as above." },
  { file: "docs/development/CLAIMS.md", name: "reuseverdicts", n: 1, kind: "DO-PATH", why: "as above." },
  { file: "docs/development/CLAIMS.md", name: "readingnameplan", n: 1, kind: "DO-PATH", why: "as above." },
  { file: "docs/development/CLAIMS.md", name: "recordsourceoutcome", n: 1, kind: "DO-PATH",
    why: "a CAPTURE delegation naming a DO path as an op. DELEGATED to CAPTURE." },
  { file: "docs/development/CLAIMS.md", name: "strength", n: 1, kind: "DO-PATH", why: "quotes UI-35's sentence. DELEGATED to UI." },
  { file: "docs/development/CLAIMS.md", name: "basis", n: 1, kind: "DO-PATH", why: "quotes UI-35's sentence. DELEGATED to UI." },
  ...
  { file: "docs/development/QUEUE.md", name: "publishcase", n: 6, kind: "DO-PATH",
    why: "M0-12's OWN scope and REC-58's landed row. QUEUE.md is CONDUCT's sole-writer file. DELEGATED to CONDUCT." },
  { file: "docs/development/QUEUE.md", name: "recordsourceoutcome", n: 1, kind: "DO-PATH",
  ...
  { file: "docs/development/research/COMPLETENESS-AUDIT.md", name: "import", n: 1, kind: "NEVER",
    why: "the audit's finding that no import op exists. Must stay absent." },
  { file: "docs/development/research/COMPLETENESS-AUDIT.md", name: "restore", n: 1, kind: "NEVER",
    why: "same finding, same sentence. Must stay absent." },
  { file: "docs/development/research/SB-EVIDENCE.md", name: "capturelimit", n: 1, kind: "DO-PATH",
    why: "a research inventory of STORE routes written with an `op=` prefix. DELEGATED to RECORD/research." },
  { file: "docs/development/research/SB-EVIDENCE.md", name: "loadcapturesession", n: 1, kind: "DO-PATH", why: "as above." },
  { file: "docs/development/research/SB-EVIDENCE.md", name: "reusedparts", n: 1, kind: "DO-PATH", why: "as above." },
  { file: "docs/development/research/SB-EVIDENCE.md", name: "siteassets", n: 1, kind: "DO-PATH", why: "as above." },
  { file: "docs/development/research/SB-EVIDENCE.md", name: "taskenqueue", n: 1, kind: "DO-PATH", why: "as above." },
