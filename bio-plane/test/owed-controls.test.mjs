/* NEGATIVE CONTROL: DECLARED HERE, RUN BY `test/owed-controls.control.mjs` — deliberately NOT a `.test.mjs`, because it EDITS REAL SOURCES while it runs and neither the battery nor the fleet walk must discover it (PL-3/PL-11/FL-3's precedent). THE HARNESS LIVES INSIDE THIS WORKTREE and never in a shared scratchpad. Every arm is armed ALONE with the other defences held OPEN, every restore is verified BY sha256 AND BY CONTENT (`cmp`), and every arm declares BEFORE it runs what MUST fail and what MUST NOT.
   ...
   ALL EIGHT ARMS RUN 2026-08-09 IN WORKTREE agent-a66f1cf86b51a86bd, each ALONE against a whole tree, every restore sha256-EQUAL and `cmp`-IDENTICAL against a per-arm pristine copy with its byte count printed and a 2,000-byte minimum guarded. EVERY ONE BEHAVED AS DECLARED. MEASURED, as `EXIT · plane register · plane arms · fleet suites/declaring/arms`, against a BASELINE row that armed nothing (`0 · 135/135 · 628 · 4/4/35`): (1) `1 · 135/135 · 628 · 3/4/26` naming harness.test.mjs — the plane's figures DID NOT MOVE, which is what says the hole was the fleet walk alone. (2) `1 · 135/135 · 628 · 4/4/34`, FLEET FLOOR on arms, control message silent. (3) `1 · 135/135 · 628 · 3/3/28` — note `3/3`, which without a suite floor reads GREENER than 4/4. (4) `1 · 134/134 · 619 · 4/4/35`, the ledger naming owed control 6 / PL-3 while the register's `No declared control` walk stayed silent, because a suite that is GONE declares nothing to nobody — the two instruments are not one thing measured twice. (5) `1 · 134/135 · 611 · 4/4/35`, both firing. (6) `1 · 135/135 · 628 · 4/4/35` on the pinned total, the outstanding CEILING silent (deleting a row LOWERS that count, which is why the total is pinned at all). (7a) `0`, unchanged. (7b) `0 · fleet 4/4/37`, the tally RISEN.
