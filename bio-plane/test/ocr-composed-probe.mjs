...
/* The four metric expressions, asserted LITERALLY present in the floor's own
   score() before they are used here. CPDF-11's guarantee, unchanged. */
const METRIC_EXPRS = [
...
console.log(`comparability: ground truth ${norm(GT_PAGE2).length} normalised chars, digest pinned; ` +
  `all four floor metric expressions present; CPDF-11 ladder recipe and prompt pinned and read, not copied`);
