...
/* CORRECTED by REC-150 (2026-09-25): 1.29.0 -> 1.31.0 — the C-95 family (§7.14's request to join) moved the
   catalogue, so the literal names the catalogue that actually runs; the subject (the catalogue's version, not the
   gate's) is unchanged. */
t("the catalog's version is recorded, not the gate's own", rat.gateVersion, "plane-gate/1.0 (bio-checks 1.31.0)");
...
/* CORRECTED 2026-09-24 by D-463: 1.25.0 -> 1.26.0. Two checks arrived in the catalogue (C-78.3
