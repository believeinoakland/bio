...
/* CORRECTED 2026-09-24 by D-512, never exempted: C-66.6 REPLAY_UNVERIFIED joined the catalogue, so CATALOG_VERSION
   took a MINOR step 1.28.0 -> 1.29.0 and the stamp this arm reads moved with it (found by asking who else reads it). */
