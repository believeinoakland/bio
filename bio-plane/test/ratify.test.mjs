...
/* CORRECTED 2026-09-24 by REC-217, never exempted: C-44.3..C-44.5 joined CASE_DERIVATION_CHECKS (op=publish's draft=
   link), the census arm forced the MINOR bump 1.28.0 -> 1.29.0, and the old literal named a catalogue that no longer
   runs. Found by asking who else reads the constant (CLAUDE.md §5). */
