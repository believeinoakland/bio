...
/* CORRECTED 2026-09-24 by D-530, never exempted: 1.28.0 -> 1.29.0. The catalogue gained C-89.1 (CAPTURE_HELD_IN_PARTS),
   the census arm forced the MINOR bump, and the old literal names a catalogue that no longer exists. */
