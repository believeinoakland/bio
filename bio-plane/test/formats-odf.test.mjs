...
/* RE-BASELINED 2026-09-26 (T3, N29, legacy-tests): this suite taken from the snapshot (96eeb2d5), the version that asserts D-346 as `odf-reader` R29 now meets it; `node test/nc-coff11.mjs` re-run over it, EVERY ARM AS DECLARED: baseline xlsx 88/0 · pptx 118/0 · odf 171/0 · e2e 57/0 GREEN; dropxlsxbound 4/4 declared (9 failing across two suites); dropslideshapes 5/5 (14); dropodpshapes 2/2 (3); dropxlsxboundunread 1/1 (1); usedrangeasbound 4/4 (8); odsborrowsgrid 3/3 (3). `nc-d346.mjs` came with it and ran AS DECLARED against the product's `src/odf.mjs` (98,312 B): skipmeta 3/3, mapbyname 3/3, fontexempt 3/3, siblings unmoved, every restore verified. */
