...
const CATALOG_CENSUS = {
  ...
  /* D-578 side, kept as history (branch row DROPPED at c22-batch30 — ours holds "1.31.0" for the union catalogue;
  ...
  /* D-615 side, kept as history (branch row DROPPED at c22-batch30 — ours holds "1.31.0" for the union catalogue;
     CONDUCT takes the union's number once and re-reads count and digest from this suite's print):
     1.34.0 (D-615, 2026-09-25, branch land/worker/D-615): ONE ARRIVAL, NO DEPARTURES, NONE CHANGED — C-86.7 ENVELOPE_DATES_DISAGREE. 506 -> 507 by this suite's print on the item's tree.
     "1.34.0": { count: 507, digest: "e48c0453b285721b1969e2b522340babb67cd0e5a1a9dc8e6ae6b95ffa63b74b" }, */
  /* D-623 side, kept as history (branch row DROPPED at c22-batch30 — ours holds "1.31.0" for the union catalogue;
     CONDUCT takes the union's number once and re-reads count and digest from this suite's print):
  ...
  /* D-680 side, kept as history (branch row DROPPED at c22-batch30 — ours holds "1.31.0" for the union catalogue;
     CONDUCT takes the union's number once and re-reads count and digest from this suite's print):
     1.31.0 (D-680, 2026-09-25, branch land/worker/D-680): ONE ARRIVAL, C-44.6 PUBLISH_DRAFT_CASE_NOT_DERIVED, and TWO CHANGED — C-44.4 (its translation names the derivation arm) and C-87.6 (D-626's reworded translation); its row carried changed: ["C-44.4", "C-87.6"], for the union's own `changed` at CONDUCT's re-read. 502 -> 503 by this suite's print on the item's tree.
     "1.31.0": { count: 503, digest: "6553872c79eabfbbb5dec071a7849d6bb242ee8c4de655e1f14684d92f1afa3a" }, */
  /* REC-215 side, kept as history (branch row DROPPED at c22-batch30 — ours holds "1.31.0" for the union catalogue;
     CONDUCT takes the union's number once and re-reads count and digest from this suite's print):
  ...
  /* D-695 side, kept as history (branch row DROPPED at c23-batch30 — ours holds "1.31.0" for the union catalogue;
     CONDUCT takes the union's number once and re-reads count and digest from this suite's print):
