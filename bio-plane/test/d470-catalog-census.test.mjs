...
const CATALOG_CENSUS = {
  ...
  /* 1.30.0 (REC-219, 2026-09-25, WORKER REC-219 under SCHEDULER #21, branch land/worker/REC-219): TWO ARRIVALS,
     NO DEPARTURES — C-41.14, `CASE_DOCUMENT_FAMILY.PENDING` (a `bio-case-document/4` must state the adoptions of
     its scope pinning a PROPOSED revision at signing) and C-41.15, `CITATIONS` (its citation edges, each with the
     version it rests on — D-579(a), carried by this row) (§3 rule 18, BOB #34). 466 -> 468, count AND digest from
     THIS SUITE'S OWN PRINT on this item's tree over origin/main 964da679, never arithmetic. (This branch first
     pushed 1.30.0 = 467 before D-579(a) joined the row; that figure never reached main and is replaced here.)
