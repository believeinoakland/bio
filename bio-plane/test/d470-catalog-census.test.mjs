...
const CATALOG_CENSUS = {
  ...
  /* 1.33.0 (D-546, 2026-09-25, WORKER D-546, branch land/worker/D-546 stacked on land/worker/D-578 700a432d): ONE ARRIVAL,
     NO DEPARTURES, NONE CHANGED — C-86.6 STATE_MOVE_UNDECLARED. 505 -> 506, count AND digest from THIS SUITE'S OWN PRINT on
  ...
  /* 1.35.0 (D-628, 2026-09-25, WORKER D-628, branch land/worker/D-628 stacked on land/worker/D-615 8b3ab6ae): ONE ARRIVAL,
     NO DEPARTURES, NONE CHANGED — C-86.8 PROMOTED_FIELD_UNSTATED. 507 -> 508, count AND digest from THIS SUITE'S OWN PRINT on
     the item's tree; no `changed` field (M0-195's grammar). IF ANOTHER BRANCH IN THE SAME BATCH ALSO MOVES THE VERSION,
     THIS ROW IS NOT THE UNION'S. */
  "1.35.0": { count: 508, digest: "1f4066611742427ca673d8ecb9b3ef4b4e41b202c319615d0c1cadd0ac608d88" },
  /* 1.36.0 (D-692, 2026-09-25, WORKER D-692, branch land/worker/D-692 stacked on land/worker/D-628 db3b94a0): ONE ARRIVAL,
     NO DEPARTURES, NONE CHANGED — C-86.9 REVISION_REDATES_CREATION. 508 -> 509, count AND digest from THIS SUITE'S OWN PRINT on
     the item's tree; no `changed` field (M0-195's grammar). IF ANOTHER BRANCH IN THE SAME BATCH ALSO MOVES THE VERSION,
     THIS ROW IS NOT THE UNION'S. */
  "1.36.0": { count: 509, digest: "5dd7f4a3ccc575b0682d95c7f3af3d49b610e4a81e97cb42956b2505f1cfd450" },
  /* 1.37.0 (D-707, 2026-09-25, WORKER D-707, branch land/worker/D-707 stacked on land/worker/D-692 332c594e): FOUR
     ARRIVALS, NO DEPARTURES, NONE CHANGED — C-86.10 .. C-86.13. 509 -> 513, count AND digest from THIS SUITE'S OWN PRINT on
     the item's tree; no `changed` field (M0-195's grammar). IF ANOTHER BRANCH IN THE SAME BATCH ALSO MOVES THE VERSION,
     THIS ROW IS NOT THE UNION'S. */
  "1.37.0": { count: 513, digest: "054a39c178463815d2a7555957c069b260cddaa06574ed489d4a4e62138b0c2c" },
  /* 1.38.0 (D-726, 2026-09-25, WORKER D-726, branch land/worker/D-726 stacked on land/worker/D-707 95839afa): ONE ARRIVAL,
     NO DEPARTURES, NONE CHANGED — C-86.14 REVISION_REGROUPS_BUNDLE. 513 -> 514, count AND digest from THIS SUITE'S OWN PRINT
     on the item's tree; no `changed` field (M0-195's grammar). IF ANOTHER BRANCH IN THE SAME BATCH ALSO MOVES THE VERSION,
     THIS ROW IS NOT THE UNION'S. */
  "1.38.0": { count: 514, digest: "d2dab62930ba947f5ecd50593cbb1bd2935e2b2fb132d90ca50af03407075b0a" },
};
...
/* CORRECTED by D-707 (2026-09-25): 1.36.0 -> 1.37.0 — C-86.10 .. C-86.13 joined the catalogue, so 1.36.0 names the old one. */
/* CORRECTED by D-726 (2026-09-25): 1.37.0 -> 1.38.0 — C-86.14 joined the catalogue, so 1.37.0 names the old one. */
