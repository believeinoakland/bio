...
const CATALOG_CENSUS = {
  ...
  "1.30.0": { count: 502, digest: "b55afdc7fb1fbce736a34f447d2df960032900e099a15a8efe02e027d9f17d8f",
              changed: ["C-41.12"] },
  /* D-668 (2026-09-25, branch land/worker/D-668 on land/worker/D-574 @ 06494735): 1.30.0 -> 1.31.0, MINOR — SEVEN
     ARRIVALS (C-22.17, C-35.15..17, C-42.8..10), NO DEPARTURES, and six rows narrowed to the one condition their
     translation is true of, named in `changed`. Count and digest are THIS SUITE'S PRINT on the item's tree. IF ANOTHER
     BRANCH IN THE SAME BATCH ALSO ADDS ROWS, THIS ROW IS NOT THE UNION'S. */
  "1.31.0": { count: 509, digest: "5a22f328102e1814503d09827d4a144ab34a02342c677cfd021787984f527d61",
              changed: ["C-22.10", "C-35.10", "C-35.11", "C-35.5", "C-42.2", "C-42.4"] },
};
...
/* CORRECTED 2026-09-25 by D-668: 1.30.0 -> 1.31.0, its seven new rows (the census row above). */
