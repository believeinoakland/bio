...
+ "one quietly reading zero",
  ...
  [true, true, true]);
t("REC-58 REACH: ALL THREE generated embeds are excluded, each recognised STRUCTURALLY and neither by "
+ "name. WAS 2 UNTIL 2026-09-13 (DS-4): release 0.57.0 publishes the fleet and "
+ "`release/pdf-worker.bundled.mjs` inlines bio-plane/src, so it is an embed of the plane for exactly the "
+ "reason the other two are. The named arms below are unchanged and still pin the two originals",
