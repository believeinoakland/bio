...
const ARMS = {
  ...
  legonly: {
    files: [CHECKS],
    why: "THE ROW'S CONTROL: drop the leg refusal (C-74.1) at every door — both of its branches. The id "
  ...
  overstrict: {
    files: [CHECKS],
    why: "THE OVER-STRICTNESS DIRECTION: C-74.1 claims any value merely CONTAINING 'theme' — a fence "
