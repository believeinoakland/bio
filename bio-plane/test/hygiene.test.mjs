...
/* REC-51: the vocabulary itself, for detector (C)'s stated-limit pin only. It is
   the SUBJECT of a relation assertion, never of a value comparison — (C) matches
   a shape and is deliberately blind to what this array currently holds. */
