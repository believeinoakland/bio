...
let snapKeySeq = 0;
/* CORRECTED 2026-09-25 at the c23-batch30 union (CONDUCT #23), never exempted: this item was cut over D-689/REC-201,
   before D-563, whose C-86.3 refuses an envelope title the held document contradicts (`Bundle <id>` against the
   document's own `title: "Records request <id>"`) — every promote here answered ENVELOPE_TITLE_DISAGREES before
   reaching C-73.6. The envelope now carries the document's OWN title, read from its front matter; its dates were
