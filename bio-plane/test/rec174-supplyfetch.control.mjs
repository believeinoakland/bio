...
/* M0-172 (scope-add, BOB #33 2026-09-24 17:12Z): the pristine copies used to be written beside `store.mjs` as `${STORE}.rec174-pristine-<arm>` —
...
const PEN = controlPen("rec174-supplyfetch");
...
const OUT = `${PEN}/rec174-control.out`;  /* M0-172: the suite output goes in the pen too, not the tree */
...
for (const name of want) {
  ...
  const pristine = `${PEN}/${STORE.split("/").pop()}.rec174-pristine-${name}`;
