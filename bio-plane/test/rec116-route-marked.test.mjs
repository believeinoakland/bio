...
t("F: and PUBLISHED beside the page — a bound applied and not published is REC-57's defect",
  page1.limit, 2);
t("F: `more` is MEASURED by reading one row past the bound, not inferred from a full page",
  page1.more, true);
...
const page2 = o((await get("provenanceroutes",
  `&limit=2&after=${encodeURIComponent(String(page1.nextAfter))}`)).result);
...
t("F: the last page says there is no more", page2.more, false);
