...
const VERSION = 'export const CATALOG_VERSION = "1.22.0";'; /* moved with the constant at c20-batch13 (CONDUCT #20) — the needle must MATCH the tree or the arm never arms, which this file's own header calls a finding */
