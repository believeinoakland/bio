...
/* RE-RUN 2026-09-25 by D-650, arms (b) (c) (h) alone, after re-anchoring them (REC-84/FW-19 had split their lines and they matched 0 times, so they had not armed since): baseline 60 pass 0 fail; oob armed 1x, 57/3, fails (1) BY NAME; nochain armed 1x, 58/2, fails (2); overstrict armed 1x, 57/3, fails the whole-document-on-an-UNREAD-capture arm. Every restore byte-identical. tools/anchordrift.mjs reads all seven anchors LIVE with no allowance (baseline has none). */
