 ...
 * copy kept in a pen OUTSIDE this worktree (`controlPen("rec161")`; M0-182), verified by sha256 AND by content (cmp), with the byte count printed and a
