...
/* Two .odt exports of one unchanged Doc, differing the way M-123 measured: a
...
t("the basis names the measurement it rests on", /M-123/.test(dg(S[0]).basis || ""), true);
