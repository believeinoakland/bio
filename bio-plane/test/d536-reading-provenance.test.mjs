/* NEGATIVE CONTROL: RUN 2026-09-24 — 7 arms, 0 not as declared (RESULTS in `nc-d536.mjs`'s header, each arm DECLARED BEFORE ARMING); the row's own arm, `nodigest` (drop the text digest), fails the attribution arm BY NAME. Re-run in one step with `node test/nc-d536.mjs` from `bio-plane/`.
 *
