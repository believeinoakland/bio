 ...
 * ELEVEN ON REC-152'S BRANCH (2026-09-19): C-22.12, the run's PRINCIPAL as the only hand that ticks or
 * closes it. C-22.11 is REC-153's, assigned by CONDUCT #6 and on its own branch; the two are merged at
 * integration, when this family holds TWELVE.
 *
