...
**Usage (P14):** the 13 job sessions processed 221.6 million tokens (`build/metrics/T2.csv`, from `archive_session`); the largest was pdf-worker (81.9M, D-622's two decoders). BOB #41's own row is recorded at its handoff. Bob's weekly meter: not given at the opening or the close.
