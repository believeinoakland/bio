...
**Status** · PROPOSED by BOB #38, 2026-09-26, awaiting Bob's approval to open (PROCESS-MECHANICS §5; TRANSITION.md T9). T1 proves the process on a small tranche (P3) and starts the metrics (P14). Everything else waits in `next.md`: the other layer-1 modules and their entries (N1–N3, N7, N11, and the carried rows) are the next tranche's.
