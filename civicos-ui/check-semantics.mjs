...
if (!got) { fail = true; console.error("FAIL: the flattened docprofile is missing from app.html"); }
else if (!got[1].includes(want)) {
  fail = true;
  console.error("FAIL: app.html's docprofile copy has drifted. Run tools/bundle-docprofile.mjs and paste the result between the markers.");
