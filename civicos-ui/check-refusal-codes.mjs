...
const FLOOR = {
  ...
  r4Suites: 42, /* CONDUCT #22 at the c22-batch29 union: 29 -> 42, the union's figure READ from `node civicos-ui/check-refusal-codes.mjs --strict`'s print on the merged tree (`ratchet: r4Suites ... measured 42`). */
  r4Pane: 15, /* CONDUCT #22 at the c22-batch29 union: 12 -> 15, the union's figure READ from `node civicos-ui/check-refusal-codes.mjs --strict`'s print on the merged tree (`ratchet: r4Pane ... measured 15`). */
