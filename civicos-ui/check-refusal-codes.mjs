...
const FLOOR = {
   ...
   * ================================================================== */
  families:     17,    // + ADMISSION_CHECKS (REC-79, C-38 — the admission gate).
  ...
  rows:        172,    // + C-38.1..6 (REC-79, the admission gate — all six DRIVEN through the op).
  ...
  census:      431,    // distinct refusal codes the plane can mint, UNION of the matcher set.
  ...
  reach:       225,    // codes a surface can receive (R1 + R2 + R3) (was 220 pre-REC-79, 217 pre-REC-69, 204 pre-REC-76, 200 pre-REC-63, 191, 187, 178, 168, 157, 127, 116, 98)
  ...
  regions:      55,    // + REC-79's `is-admission` (ONE region, six codes, SEVEN comparisons over
  ...
  regionLines: 1527,   /* MOVED 1425 -> 1527 BY REC-79, 2026-08-09: +102, `is-admission`'s own span and
  ...
  codesChecked: 151,   // + REC-79's SEVEN comparisons inside `is-admission` (six codes, one of them
  ...
  outcomeReturns: 79,   /* MOVED 70 -> 79 BY REC-79, and the +9 is TWO different things which is worth
  ...
  refusalsJudged: 154,   /* +8 by REC-79 (`is-admission`'s six codes over eight refusal outcomes),
...
const CEILING = {
  reachGap:     40,    /* codes in reach with no canned translation — may only FALL.
