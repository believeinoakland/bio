...
const FLOOR = {
  ...
  untranslated: 300, /* D-484 (C-33.40 NO_BASIS, C-33.41 NO_CITATION consolidated behind one governed helper each, 2026-09-24, branch land/worker/D-484): FELL 301 -> 299 from this guard's own --strict print on the item's tree over origin/main 16fe1e7f. ZERO pre-existing slack: the PRISTINE origin/main 16fe1e7f, run before any edit in this worktree, printed exit 0 with EVERY ratchet key at slack 0.
