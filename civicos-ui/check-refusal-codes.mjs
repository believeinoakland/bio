...
const FLOOR = {
  ...
  families: 22,    // + AI_RUNS_CONTEXT_CHECKS (REC-69, C-36 — the context-keyed run list).
  /* ================================================================== *
  ...
  rows: 205,    /* MOVED 174 -> 176, 2026-08-10, worktree agent-a36b6782b06f5a651 (CASE-3), READ
  ...
  census: 490,    /* MOVED 433 -> 437, 2026-08-10, worktree agent-a36b6782b06f5a651 (CASE-3), from
  ...
  reach: 258,    /* MOVED 227 -> 229, 2026-08-10, worktree agent-a36b6782b06f5a651 (CASE-3), from
  ...
  governedSites: 81,   // spans named by a row's `where` — a function, or a region inside one.
  ...
  regions: 67,    // + REC-69's `is-airuns-context` (ONE region, three codes, every one COMPARED —
  ...
  regionLines: 2035,   /* MOVED 1407 -> 1425 BY REC-69'S REPLAY, 2026-08-09, RE-READ FROM A GREEN RUN
  ...
  codesChecked: 201,   // + REC-69's THREE (C-36.1..3), all COMPARED: the region's `refusal` helper sits
  ...
  refusalsJudged: 203,   /* +3 by REC-69 (C-36.1..3 inside `is-airuns-context`), 2026-08-09, from the
