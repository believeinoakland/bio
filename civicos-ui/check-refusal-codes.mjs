...
const MULTI_SITE_CANDIDATES = new Set([
  ...
  /* c22-batch29 union (CONDUCT #22): D-147's LIFECYCLE_TEXT_UNWRITABLE, READ at its two sites in actionCorrespond's
     is-lifecycle-writable region and found to be TWO conditions — (1) exemptions/due_cite too long or holding a quote,
     backslash or newline; (2) stage/follows/outcome/due_by not a single lower-case token. C-94.11's sentence (`The
