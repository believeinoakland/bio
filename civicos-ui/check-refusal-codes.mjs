...
const FLOOR = {
  ...
  untranslated: 295, /* D-126 (C-68 PER_ITEM_CHECKS + C-69 TASK_ACTOR_CHECKS, 2026-09-23, branch land/worker/D-126): MOVED 296 -> 295 from this guard's own print on the item's tree — FELL by 1, and the fall is a CLOSURE rather than slack: NOT_YOURS was untranslated and now carries C-69.1's canned translation, because a queue selection can surface it to a member (reachGap held at 40 for that reason). */   /* UI-81 (C-44.2 FINDING_IN_SEVERAL_CASES in CASE_DERIVATION_CHECKS, 2026-09-23, worktree agent-a306ff29faf082ef3): FELL 297 -> 296 from this guard's own print, and THE FALL IS NOT SLACK: FINDING_IN_SEVERAL_CASES was in arm F's subject (F6, one site, out of reach) and left it because it now carries a canned translation — the census is unchanged at 608 and the partition still sums to exactly this figure (F6 168 -> 167). A floor that falls needs its reason at the site; this is it. */
