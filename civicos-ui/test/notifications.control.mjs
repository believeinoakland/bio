...
const ARMS = [
  ...
  /* UI-97's arms. 15 is the state this item FOUND — a member with no way back;
     16 is the row's own NEGATIVE CONTROL (omit `unmute:true`, and the round trip
     fails by name); 16b is the honesty half, a case undo drawn over kinds this
     surface cannot see; 17 is the over-strictness arm. */
  { id: "15-report-offers-no-undo", file: APP, mustFail: true, says: "carries a per-item undo",
  ...
  { id: "16-undo-omits-the-flag", file: APP, mustFail: true, says: "AS THE ITEM FORM CARRYING unmute",
  ...
  { id: "16b-case-undo-guesses-kinds", file: APP, mustFail: true, says: "draws NO undo control",
  ...
  { id: "17-over-strictness-unmute", file: APP, mustFail: false,
