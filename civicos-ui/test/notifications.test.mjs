 ...
 * verified by sha256 and cmp. ARM 18 (the report offers no undo — the state this
 * item found) fails "…carries a per-item undo" and the two case arms; ARM 19 (the
 ...
 * round-trip arms; ARM 19b (the case undo drawn over kinds this surface cannot
